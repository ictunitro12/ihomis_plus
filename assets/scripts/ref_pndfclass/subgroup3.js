...
$('#frmSubGroup3').validate({
	submitHandler: function (form) {
		var POSTURL = baseURL + "Ref_PNDFClass/saveSubGroup3";
		$.ajax({
			type: "POST",
			url: POSTURL,
			dataType: "JSON",
	...
	messages: {
		sg3code: 'Sub Group 3 is required!',
		sg3desc: 'Description is required!',
	},
