...
$('#frmSubGroup4').validate({
	submitHandler: function (form) {
		var POSTURL = baseURL + "Ref_PNDFClass/saveSubGroup4";
		$.ajax({
			type: "POST",
			url: POSTURL,
			dataType: "JSON",
	...
	messages: {
		sg4code: 'Sub Group 4 is required!',
		sg4desc: 'Description is required!',
	},
