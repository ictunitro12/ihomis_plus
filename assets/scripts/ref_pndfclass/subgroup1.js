...
$('#frmSubGroup1').validate({
	submitHandler: function (form) {
		var POSTURL = baseURL + "Ref_PNDFClass/saveSubGroup1";
		$.ajax({
			type: "POST",
			url: POSTURL,
			dataType: "JSON",
	...
	messages: {
		sg1code: 'Sub Group 1 is required!',
		sg1desc: 'Description is required!',
	},
