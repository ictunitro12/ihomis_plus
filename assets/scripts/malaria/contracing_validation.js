...
$('#frmAddContactTracing').validate({
	submitHandler: function (form) {
		var  POSTURL = baseURL+"Malaria/saveContactTracing";
		...
		$.ajax({
			...
			success: function(data){
				if($('#ContactIden').val()=='insert')
				{
					toastr.success(' Successfully Saved! ' ,'Success');
                    $('#AddContactTracing').modal('hide');
                     ConTraceList(enccode,hpercode);  		
				}
				else if($('#ContactIden').val()=='update')
				{
					toastr.success(' Successfully Saved! ' ,'Success');
                    $('#AddContactTracing').modal('hide');
                     ConTraceList(enccode,hpercode);  		
