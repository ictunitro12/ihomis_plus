...
$('#frmDeleteFollow').validate({
  submitHandler: function (form) {
    var  POSTURL = baseURL+"MalariaLab/deleteMalariaFollow";
    ...
    $.ajax({
      ...
      success: function(data){
        if($('#delFollowformIden').val()=='delete'){
          toastr.success('Successfully Deleted! ' ,'Success');  
          $('#DeleteFollow').modal('hide');
          FollowList(enccode,hpercode); 
        }
        else{
