...
$('#frmChikungunya').validate({
submitHandler: function (form) {
var  POSTURL = baseURL+"PIDSR_Chikungunya/saveChikungunya";
		  $.ajax({
			type : "POST",
			url  : POSTURL,
			dataType: "JSON",
			...
			success: function(data){
				if($('#formIden').val()=='insert')
				{
					toastr.success(' Successfully Saved! ' ,'Success');
					 window.location.replace(baseURL+"PIDSR_Chikungunya");		
				}
