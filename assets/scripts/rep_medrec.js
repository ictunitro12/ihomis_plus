...
function checkTyphoid(enccode,hpercode)
	...
	{ 	
		...
		$('#typ_hospcode').val($('#hospcode').val());
		$('#typ_typecode').val($('#typecode').val());

		$('#typ_info_street_temp').val($('#info_street_temp').val());
		$('#typ_selBrgyTemp').val($('#selBrgyTemp').val());
		$('#typ_selCityTemp').val($('#selCityTemp').val());
		$('#typ_selProvTemp').val($('#selProvTemp').val());
		$('#typ_selRegTemp').val($('#selRegTemp').val());

		$('#typ_selIndig').val($('#selIndig').val());
		$('#typ_consult').val($('#consult').val());
		$('#typ_FIRST').val($('#FIRST').val());

		$('#typ_place_consult').val($('#place_consult').val());
		$('#typ_admit').val($('#admit').val());
		$('#typ_seen').val($('#info_seen').val());
		$('#typ_onset_ill').val($('#onset_ill').val());
		$('#typ_sample').val($('#sample').val());

		$('#typ_case_classif').val($('#case_classif').val());
		$('#typ_out').val($('#out').val());
		$('#typ_specimen_collect').val($('#specimen_collect').val());

		$('#typ_widal').val($('#widal').val());
		$('#typ_typhoidot').val($('#typhoidot').val());
		$('#typ_tube').val($('#tube').val());
		$('#typ_stool').val($('#stool').val());
	}
	...
	function Typhoidwizard()
	{
		...
		.on('click',function(){$('#TyphoidSummary').modal('show');
			TyphoidSummary();});
