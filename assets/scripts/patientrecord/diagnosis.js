		...
		data.coldef =[
						...
						searchable:false,
							render: function ( data, type, row ) 
							{
								switch(data) 
								{
									case 'ADMDX' : return '<div class="text-primary">ADMITTING</span>'; break;
									case 'FINDX' : return '<div class="text-success">FINAL</span>'; break;
									case 'WODIA' : return '<div class="text-success">WORKING</span>'; break;
									case 'WORDX' : return '<div class="text-success">INTERIM</span>'; break;
									case 'CLIDI' : return '<div class="text-success">CLINICAL</span>'; break;
									case 'OTHER' : return '<div class="text-success">OTHER</span>'; break;
									case 'Y' : return '<div class="text-success">YES</span>'; break;
									case 'N' : return '<div class="text-success">NO</span>'; break;
...
function addDiagnosis(enccode,hpercode)
{
	...
	$('#diagList').on('click','#btnEditDiag',function(){
		...
		success: function(data)
		{
			...
			$("#diagType option[value=" + obj['tdcode']+ "").prop('selected', true);
			$("#diagPrime option[value=" + obj['primediag']+ "").prop('selected', true);
