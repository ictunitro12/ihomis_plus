...
<body>
<a class="btn btn-primary" href="<?php echo site_url('ModeOfAdmission/Create');?>">Add</a>

<table id="ModeOfAdmission" class="table table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
...
<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#ModeOfAdmission").dataTable({
                    initComplete: function() {
                        var api = this.api();
                        $('#ModeOfAdmission input')
                                .off('.DT')
					...
					paging: true,
					autoWidth: true,
                    ajax: {"url": "<?php echo base_url();?>index.php/ModeOfAdmission/ModeOfAdmission_list", "type": "POST"},
                 	columnDefs: 
					[
				    {
					targets : [2],
