    ...
    <div>
                    ...
                    <form id="form-step-2" role="form">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control form-control-lg" name="dateaccom" id="dateaccom"
                                            type="datetime-local">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input class="form-control form-control-md" name="patagemo"
                                                    id="patagemo" type="number" placeholder="month(s)" readonly>
                                            </div>
                                            <div class="col-md-3">
                                                <input class="form-control form-control-md" name="patagedy"
                                                    id="patagedy" type="number" placeholder="day(s)" readonly>
                                            </div>
                                            <div class="col-md-3">
                                                <input class="form-control form-control-md" name="patagehr"
                                                    id="patagehr" type="number" placeholder="hour(s)" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-control-md  form-control-lg" name="modaccom"
                                    id="modaccom">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-control-md  form-control-lg" name="insurance"
                                    id="insurance">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="Bed" name="adm_Bed" class="form-control  form-control-lg"
                                    placeholder="Bed">
                                <input type="hidden" id="selBed" name="adm_bdintkey"
                                    class="form-control  form-control-lg" placeholder="Bed" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label  text-default mb-1">Room:</label>
                                <input type="text" class="form-control form-control-md  form-control-lg" name="adm_Room"
                                    id="Room" placeholder="Ward name">
                                <input type="hidden" id="selRoom" name="adm_rmintkey"
                                    class="form-control  form-control-lg" placeholder="Bed" readonly>
                            </div>
                            <div class="col-md-12">
                                <label class="col-form-label  text-default mb-1">Ward:</label>
                                <input type="text" class="form-control form-control-md  form-control-lg" name="adm_Ward"
                                    id="Ward" placeholder="Ward name">
                                <input type="hidden" class="form-control form-control-md  form-control-lg"
                                    name="adm_wardcode" id="selWar" readonly placeholder="Ward name">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select class="form-multi-select" data-coreui-multiple="false" data-width="100%"
                                name="selDoc_doc" id="ADMIT">
                                <option value=""> </option>
                            </select>
                            <div class="clearfix">
                                <hr>
                            </div>
                            <h5 class="text text-success mb-3"><i class="fa fa-user-circle-o"></i> Admitting Details
                            </h5>
                            <div class="box-body box-profile">
                                <img id="admitDocPic"
                                    class="img-fluid bg-body shadow-3 img-thumbnail rounded mx-auto d-block mb-1"
                                    width="200px" src="<?php base_url(); ?>/assets/img/avatars/none.png"
                                    alt="User profile picture">
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-user fa-sm"></i>&nbsp Doctor's
                                            Name <a class="pull-right text text-success" id="docName_admit">N/A</a>
                                        </div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-venus-mars fa-sm"></i>&nbsp
                                            Category: <a class="pull-right text text-success" id="docCat_admit">N/A</a>
                                        </div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-intersex fa-sm"></i>&nbsp
                                            Department: <a class="pull-right text text-success"
                                                id="docDept_admit">N/A</a></div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-calendar fa-sm"></i>&nbsp Contact
                                            #:<a class="pull-right text text-success" id="docTel_admit">N/A</a></div>
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box-body box-profile">
                                ...
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-user fa-sm"></i>&nbsp Doctor's
                                            Name <a class="pull-right text text-success" id="docName_consu">N/A</a>
                                        </div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-venus-mars fa-sm"></i>&nbsp
                                            Category: <a class="pull-right text text-success" id="docCat_consu">N/A</a>
                                        </div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-intersex fa-sm"></i>&nbsp
                                            Department: <a class="pull-right text text-success"
                                                id="docDept_consu">N/A</a></div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-calendar fa-sm"></i>&nbsp Contact
                                            #:<a class="pull-right text text-success" id="docTel_consu">N/A</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="box-body box-profile">
                                ...
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-user fa-sm"></i>&nbsp Doctor's
                                            Name <a class="pull-right text text-success" id="docName_atten">N/A</a>
                                        </div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-venus-mars fa-sm"></i>&nbsp
                                            Category: <a class="pull-right text text-success" id="docCat_atten">N/A</a>
                                        </div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-intersex fa-sm"></i>&nbsp
                                            Department: <a class="pull-right text text-success"
                                                id="docDept_atten">N/A</a></div>
                                    </div>
                                    <div class="list-group-item">
                                        <div class="text text-success"><i class="fa fa-calendar fa-sm"></i>&nbsp Contact
                                            #:<a class="pull-right text text-success" id="docTel_atten">N/A</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <form id="form-step-4" role="form" data-toggle="validator">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <textarea name="AdmissionDiag" id="AdmissionDiag" type="text" Placeholder="Admission Diagnosis"
                            class="form-control"></textarea>
                    </div>
                    <div class="col-6">
                        <label class="form-label">Reason for Admission:</label>
                        <textarea name="ReasonDiag" id="ReasonDiag" type="text" Placeholder="Reason for Admission"
                            class="form-control"></textarea>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="h4 text-success"><i class="fa fa-ambulance" aria-hidden="true"></i>&nbsp; For Referral From
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
        ...
        <div id="step-5" class="">
            <div id="form-step-6" role="form">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="text text-success with-border"><i class="fa fa-user"></i>&nbsp Responsible for the
                            account.</h4>
                        <div class="col-md-12">
                            <label class="form-label">Fullname:</label>
                            <input type="text" class="form-control form-control-xs" placeholder="Fullname" name="rfname"
                                id="rfname">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Contact:</label>
                            <input type="text" class="form-control" placeholder="Mobile/Telephone" name="rcontact"
                                id="rcontact">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Current Address:</label>
                            <textarea class="form-control" name="raddress" Placeholder="Complete Address"
                                id="raddress"></textarea>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <h4 class="text text-success with-border"><i class="fa fa-check"></i>&nbsp Source of Payment
                        </h4>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <select name="sop1" id="sop1" class="form-control form-control-md mb-1">
                                    ...
                                    <option value="NOCHA">No charge (free, charity, special research or teaching)
                                    </option>
