 ...
 <div class="row">
	<div class="col-md-12">
		...
		<form id="frmMedicoLegalAll" name="frmMedicoLegalAll" method="post">
			<div class="card card-accent-success">
				<div class="card-header">
					<div class="row">
						<div class="col-md-6 col-md-auto">
							<div class="h3 text text-success">
								<h4 class="modal-title text-success"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;Medico Legal ALL</h4>
							</div>
						</div>
						<div class="col-md-6 col-md-auto">
				...
				<div class="card-body" id="MedicoLegalAll"></div>
...
<input name="module" id="module" type="hidden" value="medicolegalall">
...
<script src="<?php echo base_url()?>assets/scripts/medicolegalall/legalall.js"></script>
