  ...
  <div class="modal-content">
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          Lot no :
          <input  type="text" class="form-control form-control-md" name="delLotno" id="delLotno" placeholder='Lot no'>
        </div>
        <div class="col-md-6">
          Remarks :
...
<div class="modal" id="modaldrugData" tabindex="-1" role="dialog" style="overflow: auto;">
