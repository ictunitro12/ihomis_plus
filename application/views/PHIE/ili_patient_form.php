...
<div class="card card-accent-success">
	...
	<div class="card-body">
		...
		<div class="row">
			...
			<div class="col-md-2">
				<input type="date" class="form-control form-control-mb mb-1" id="date_consult" name="date_consult">
			</div>
			<label class="col-md-2 col-form-label text-default mb-1"><i class="fa fa-asterisk text-danger"></i> Date Onset of Illness?:</label>
			<div class="col-md-2">
				<input type="date" class="form-control form-control-mb mb-1" id="date_onset" name="date_onset">
			</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<input type="date" class="form-control form-control-mb mb-1" id="coldte" name="coldte">
			</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<input type="date" class="form-control form-control-mb mb-1" id="date_vaccination" name="date_vaccination" value="" disabled>
			</div>
		</div>