...
<div class="row">
	<div class="col-md-6">
		<div class="row">
			<div class="col-md-6">
				...
				<input type="datetime-local"  name="dateVisit" id="dateVisit" class="form-control form-control" required>
			</div>
			<div class="col-md-6">
	...
	<div class="row">
		<div class="col">
			<div class="h4 text text-success"><i class="fa fa-wheelchair"></i>&nbsp Injury/Incident</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6">
			<label class="text-default">Date:</label>
			<input type="datetime-local"  name="dateIncident" id="dateIncident" class="form-control form-control">
		</div>
		<div class="col-md-6">
			<label class="text-default">Place:</label>
			<textarea class="form-control" data-width="100%" placeholder ="Address of incident" name="placeIncident" id="placeIncident"></textarea>
		</div>
	</div>
</div>
<div class="col-md-6">
...
<div class="col-md-6">
	...
	<input type="datetime-local"  name="dateDischarge" id="dateDischarge" class="form-control form-control-mb" >
</div>
<div class="col-md-6">
...
<div class="col-md-12">
	<label class=" text-default">Reason for admission:</label><small>Note: if the patient is for admission.</small>
	<textarea type="text" disabled class="form-control"  name="reasAdmit" id ="reasAdmit" Placeholder ="Reason for Admission"></textarea>
</div>
</div>
</form>
</div>
