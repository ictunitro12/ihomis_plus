	...
	<main class="c-main">
		<div class="container-fluid">
			<div class="c-fade-in">
					...
					&nbsp Second Case Rates
						</div>
						</h3>
							<div class="card-body table-responsive">
								<table id="secondCaserateTable" class="table table-sm table-striped  table-bordered table-condensedtable-hover ">
									<thead>
										<tr class="thead-dark">
...
<script type="text/javascript">
	...
	var t = $("#secondCaserateTable").dataTable({	
	oLanguage: {
	...
	autoWidth: true,
	destroy: true,
	ajax: {"url": "<?php echo base_url();?>Ref_Caserate/SecondCaseRateList", "type": "POST"}, 
	columnDefs: [
