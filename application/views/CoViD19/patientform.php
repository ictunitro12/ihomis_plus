...
<div id="smartwizard">
	<ul>
		...
		<li>
			<a href="#step-2"><i class="fa fa-stethoscope fa-2x"></i><br /><small>Case Investigation Details</small></a>
		</li>
		<li>
			<a href="#step-3"><i class="fa fa-wheelchair fa-2x"></i><br /><small>Consultation Information</small></a>
		</li>
		<li>
			<a href="#step-4"><i class="fa fa-wheelchair fa-2x"></i><br /><small>Contact Tracing</small></a>
		</li>
	</ul>
	<div>
		<div id="step-1">
			<form id="form-step-1">
				<div class="alert alert-info" role="alert"><i class="fa fa-info-circle fa-lg"></i>&nbsp <b>Information:</b> <small>All fields mark with (asterisk) <i class="fa fa-asterisk text-danger"></i> are required!</small></div>
				<div class="card card-accent-success">
					<div class="card-header">
						<div class="col-md-6">
							<h4 class="card-title text-success"><i class="fa fa-user-circle-o"></i>&nbsp CoViD-19 Form</h4>
						</div>
						<div class="row">
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-6">
										...
										<hr class="bg-success">
										<div class="form-row">
											<label class="col-md-2 col-form-label text-default mb-1">House no./Lot/Bldg. Street/Purok/Sitio</label>
											<div class="col-md-10">
												<textarea type="text" class="form-control form-control-mb mb-1" id="info_street" name="info_street" readonly placeholder="House no./Lot/Bldg./Street/Purok/Sitio"></textarea>
											</div>
										</div>
										<div class="form-row">
											<label class="col-md-2 col-form-label text-default mb-1">Municipality/City</label>
											<div class="col-md-4">
												<input type="text" class="form-control form-control-mb mb-1" readonly id="city" name="city" placeholder="Municipality/City">
											</div>
									...
									<div class="col-md-6">
										<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Disease Reporting Unit</div>
										<hr class="bg-success">
										<div class="form-row">
			...
			<form id="form-step-2" role="form">
				...
				<div class="card card-accent-success">
					<div class="card-header">
						<div class="row">
							<div class="col-md-6">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Interviewer</div>
								<hr class="bg-success">
								<div class="form-row">
									<label class="col-md-2 col-form-label text-default mb-1">Name</label>
									<div class="col-md-10">
										<input type="text" class="form-control form-control-mb mb-1" id="iname" name="iname">
									</div>
							...
							<div class="col-md-6">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Informant</div>
								<hr class="bg-success">
								<div class="form-row">
									<label class="col-md-2 col-form-label text-default mb-1">Name</label>
									<div class="col-md-10">
								...
								<div class="form-row">
									<label class="col-md-2 col-form-label text-default mb-1">Relationship</label>
									<div class="col-md-10">
							...
							<div class="col-md-12">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;If existing case</div>
								<hr class="bg-success">
							</div>
							<div class="col-md-2">
								<div class="form-row">
							...
							<div class="col-md-6">
								...
								<div class="form-row">
									...
									<div class="col-md-10">
										<input type="text" class="form-control form-control-mb mb-1" id="iecosspecify" name="iecosspecify" placeholder="Specify" readonly>
									</div>
								</div>
							</div>
							<p>
							...
							<div class="col-md-6">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Type of Client</div>
								<hr class="bg-success">
								<div class="form-row">
									<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Testing Category/ Subgroup</div>
								<hr class="bg-success">
								<div class="form-row">
									<div class="col-md-1">
							...
							<div class="col-md-6">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Current Address in the Philippines and Contact Information</div>
								<hr class="bg-success">
								<div class="form-row">
							...
							<div class="col-md-6">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Current Workplace Address and Contact Information</div>
								<hr class="bg-success">
								<div class="form-row">
								...
								<div class="form-row">
									<label class="col-md-2 col-form-label text-default mb-1">Street</label>
									<div class="col-md-10">
							...
							<div class="col-md-12">
								<hr class="bg-success">
								<div class="h5 text-success"><i class="fa fa-map"></i>&nbsp;&nbsp;Special Population</div>
								<hr class="bg-success">
								<div class="form-row">
									<label class="col-md-3 col-form-label text-default mb-1">Health Care Worker</label>
									<div class="col-md-1">
									...
									<div class="col-md-4">
										<input type="text" class="form-control form-control-mb mb-1" id="hcwnohfacility" name="hcwnohfacility" placeholder="Name of health facility" readonly>
									</div>
									<div class="col-md-3">
										<input type="text" class="form-control form-control-mb mb-1" id="hcwlocation" name="hcwlocation" placeholder="Location" readonly>
									</div>
								</div>
								<p>
								<div class="form-row">
									<label class="col-md-3 col-form-label text-default mb-1">Returning Overseas Filipino</label>
									<div class="col-md-1">
									...
									<div class="col-md-4">
										<input type="text" class="form-control form-control-mb mb-1" id="rofcoorigin" name="rofcoorigin" placeholder="Country of origin" readonly>
									</div>
									<div class="col-md-3">
										<input type="text" class="form-control form-control-mb mb-1" id="rofpnumber" name="rofpnumber" placeholder="Passport number" readonly>
									</div>
								</div>
								<div class="form-row">
									<label class="col-md-5 col-form-label text-default mb-1"></label>
									<div class="col-md-1">
										<input type="radio" id="ofwo" name="sprofilipinoo" value="1" readonly>&nbsp;&nbsp;
										<label class="col-form-label text-default" for="ofwo">OFW</label>
									</div>
									<div class="col-md-1">
										<input type="radio" id="ofwn" name="sprofilipinoo" value="2" readonly>&nbsp;&nbsp;
										<label class="col-form-label text-default" for="ofwn">Non-OFW</label>
									</div>
								</div>
								<p>
								<div class="form-row">
									<label class="col-md-3 col-form-label text-default mb-1">Foreign National Traveler</label>
									<div class="col-md-1">
									...
									<div class="col-md-4">
										<input type="text" class="form-control form-control-mb mb-1" id="fntcoorigin" name="fntcoorigin" placeholder="Country of origin" readonly>
									</div>
									<div class="col-md-3">
										<input type="text" class="form-control form-control-mb mb-1" id="fntpnumber" name="fntpnumber" placeholder="Passport number" readonly>
									</div>
								</div>
								<p>
								<div class="form-row">
									<label class="col-md-3 col-form-label text-default mb-1">Locally Stranded Individual / APOR / Local Traveler</label>
									<div class="col-md-1">
									...
									<div class="col-md-4">
										<input type="text" class="form-control form-control-mb mb-1" id="lsialtcmpo" name="lsialtcmpo" placeholder="City, Municipality and Province of origin" readonly>
									</div>
								</div>
								<div class="form-row">
									<label class="col-md-5 col-form-label text-default mb-1"></label>
									<div class="col-md-2">
										<input type="radio" id="lsialtlsi" name="lsialt" value="1" readonly>&nbsp;&nbsp;
										<label class="col-form-label text-default" for="lsialtlsi">Locally Stranded Individual</label>
									</div>
									<div class="col-md-3">
										<input type="radio" id="lsialtalt" name="lsialt" value="2" readonly>&nbsp;&nbsp;
										<label class="col-form-label text-default" for="lsialtalt">Authorized Person Outside Residence / Local Traveler</label>
									</div>
								</div>
								<p>
								<div class="form-row">
									<label class="col-md-3 col-form-label text-default mb-1">Lives in Closed Settings</label>
									<div class="col-md-1">
									...
									<div class="col-md-4">
										<input type="text" class="form-control form-control-mb mb-1" id="licsitype" name="licsitype" placeholder="Institution type" readonly>
									</div>
									<div class="col-md-3">
										<input type="text" class="form-control form-control-mb mb-1" id="licsname" name="licsname" placeholder="Name" readonly>
									</div>
								</div>
							</div>
						</div>
			...
			<form id="form-step-3" role="form">
				...
				<div class="card card-accent-success">
					<div class="card-header">
						<div class="row">
							<div class="col-md-12">
								<div class="h5 text-success"><i class="fa fa-medkit"></i>&nbsp;&nbsp;Consulation Information</div>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div class="form-row">
							<div class="col-md-6">
								<div class="form-row">
									...
									<div class="col-md-1">
										<input type="radio" id="ciprevcovidconsuly" name="hpcrc" value="1">&nbsp;&nbsp;
										<label for="ciprevcovidconsuly">Yes</label>
									</div>
									<div class="col-md-1">
										<input type="radio" id="ciprevcovidconsuln" name="hpcrc" value="2">&nbsp;&nbsp;
										<label for="ciprevcovidconsuln">No</label>
									</div>
									<div class="col-md-5">
										<input type="datetime-local" class="form-control form-control-mb mb-1" autocomplete="off" id="ciprevcovidconsuldofc" name="ciprevcovidconsuldofc" readonly>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-row">
									<div class="col-md-12">
										<input type="text" class="form-control form-control-mb mb-1" id="cifacname" name="cifacname" placeholder="Name of facility where first consult was done" readonly>
									</div>
								</div>
							</div>
							...
							<div class="form-row">
								<div class="col-md-6">
									<div class="h5 text-success"><i class="fa fa-medkit"></i>&nbsp;&nbsp;Disposition at Time of Report</div>
									<div class="form-row">
										<div class="col-md-4">
										...
										<div class="col-md-8">
											<input type="text" class="form-control form-control-mb mb-1" id="datorahname" name="datorahname" readonly placeholder="Name of Hospital">
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-8">
											<input type="text" class="form-control form-control-mb mb-1" id="datoraiqname" name="datoraiqname" readonly placeholder="Name of Isolation / Quarantine facility">
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-10">
											<input type="text" class="form-control form-control-mb mb-1" id="daotrospecify" name="daotrospecify" placeholder="Specify" readonly>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									...
									<div class="form-row">
										...
										<div class="col-md-5">
											<input type="datetime-local" class="form-control form-control-mb mb-1" autocomplete="off" id="datorahdt" name="datorahdt" readonly>
										</div>
										<label class="col-md-5 col-form-label text-default mb-1"></i>Date and Time isolated/quarantined in facility</label>
										<div class="col-md-5">
											<input type="datetime-local" class="form-control form-control-mb mb-1" autocomplete="off" id="datoraiqdt" name="datoraiqdt" readonly>
										</div>
										<label class="col-md-5 col-form-label text-default mb-1"></i>Date and Time isolated/quarantined at home</label>
										<div class="col-md-5">
											<input type="datetime-local" class="form-control form-control-mb mb-1" autocomplete="off" id="datorihiqdt" name="datorihiqdt" readonly>
										</div>
										<label class="col-md-5 col-form-label text-default mb-1"></i>Date of Discharge</label>
										<div class="col-md-5">
											<input type="datetime-local" class="form-control form-control-mb mb-1" autocomplete="off" id="datordhdd" name="datordhdd" readonly>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-row">
									<label class="col-form-label h5 text-success mb-1"><i class="fa fa-medkit"></i>&nbsp;&nbsp;2.5. Vaccination Information</label>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-row">
							...
							<div class="col-md-12">
								...
								<div class="form-row">
									...
									<label class="col-md-6 col-form-label text-default mb-1">Comorbidities</label>
								</div>
								<div class="form-row">
									<div class="col-md-2">
							...
							<div class="col-md-12">
								<div class="form-row">
									...
									<div class="col-md-2">
										<input type="datetime-local" class="form-control form-control-mb  mb-1" autocomplete="off" id="tpurtpcrscd" name="tpurtpcrscd">
									</div>
								</div>
								<div class="form-row">
							...
							<div class="col-md-12">
								...
								<div class="form-row">
									<div class="col-md-12">
										<div class="form-row form border">
											<div class="col-md-2">
												<input type="datetime-local" class="form-control form-control-sm sm-1" autocomplete="off" id="labdc" name="labdc">
											</div>
											<div class="col-md-2">
												<input type="datetime-local" class="form-control form-control-sm sm-1" autocomplete="off" id="labdr" name="consult_date">
											</div>
											<div class="col-md-2">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-row">
									...
									<label class="col-md-2 col-form-label text-right mb-1">Date of last contact</label>
									<div class="col-md-2">
