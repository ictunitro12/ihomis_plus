            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="billingType" checked id="billingType"
                            value="final">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="billingType" disabled id="billingType"
                            value="tenta">
                        <label class="form-check-label" for="billingType">
                            Tentative
                        </label>
                    ...
                    <hr>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="billingMode" id="billingMode"
                            value="details">
                    ...
                    <hr>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="billingClaim" id="billingClaim"
                            value="phic">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-outline-success btn-lg btn-block"><i
                            class="fa fa-file-pdf-o"></i> GENERATE</button>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="btn-group pull-right" role="group" aria-label="">
                <button type="button" id="btnCharge_add" title="" class="btn btn-outline-success btn-md"
                    data-style="zoom-in"><i class="fa fa-plus"></i> Add Charges</button>
