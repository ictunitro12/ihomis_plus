        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="dialog" id="modalSize">
            <div class="modal-content">
                <div class="modal-body">
                    <h4 class="modal-title text-success"><i class="fa fa-refresh" id="modalAdjIcon"></i> <span
                            id="modalAdjTitle">Add Adjustment</span></h4>
                    <br>
                    <div class="row">
                        <div class="col-md-6" id="selectCostCenter">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-8">
                                    <input type="datetime-local" class="form-control form-control-mb" id="adjDateLog"
                                        name="adjDateLog" placeholder="">
                                </div>
                                <div class="col-md-4 col-form-label text-default mb-1">
                                    Cost Center:
                                </div>
                                <div class="col-md-8">
                                    <select name="adjCostcntr" id="adjCostcntr" onclick="adjustmentSel(this.value)"
                                        class="form-control form-control-md" placeholder="Cost Center">
                                ...
                                <div class="col-md-8">
                                    <input type="hidden" class="form-control form-control-mb" autocomplete="off"
                                        id="adjItemcode" name="adjItemcode">
                                    <textarea class="form-control form-control-mb mb-1" autocomplete="off" readonly
                                        placeholder="Item/Procedure" id="adjItemdesc" name="adjItemdesc"></textarea>
                                </div>
                                <div class="col-md-4 col-form-label text-default mb-1">
                                    Unit of Measurement:
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-mb" autocomplete="off" readonly
                                        id="adjOum" name="adjOum" placeholder="0">
                                </div>
                                <div class="col-md-4 col-form-label text-default mb-1">
                                    Quantity:
                                </div>
                                <div class="col-md-8">
                                    <input type="number" class="form-control form-control-mb" min="0" autocomplete="off"
                                        id="adjQty" name="adjQty" placeholder="0">
                                </div>
                                <div class="col-md-4 col-form-label text-default mb-1">
                                    Price:
                                </div>
                                <div class="col-md-8">
                                    <input type="number" class="form-control form-control-mb" min="0" autocomplete="off"
                                        id="adjPrice" name="adjPrice" placeholder="0">
                                </div>
                                <div class="col-md-4 col-form-label text-default mb-1">
                                    Amount:
                                </div>
                                <div class="col-md-8">
                                    <input type="number" class="form-control form-control-mb" min="0" autocomplete="off"
                                        readonly id="adjAmount" name="adjAmount" placeholder="0">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-mb" autocomplete="off" readonly
                                        id="adjRef" name="adjRef" placeholder="Reference No">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control form-control-mb" autocomplete="off" id="adjType"
                                        name="adjType">
                        ...
                        <div class="col-md-6" id="selectTypeofCharge">
                            ...
                            <select name="typechrge_adj" id="typechrge_adj" class="form-control form-control-sm"
                                aria-label="Type of Charge"></select>
                            <hr>
                            <table id="chargesAdjust" class="table table-sm table-hover table-bordered table-condensed"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th>Code</th>
                ...
                <div class="modal-footer">
                    <div class="btn-group float-right">
                        <button type="submit" class="btn btn-outline-success btn-md"><i class="fa fa-save"></i>
                            Save</button>
                        <button class="btn btn-outline-danger btn-md" data-dismiss="modal"><i class="fa fa-close"></i>
                            Close</button>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-2">
            <div class="btn-group pull-right" role="group" aria-label="">
                <button type="button" id="btnAdjust" title="" class="btn btn-outline-success btn-md"
                    data-style="zoom-in"><i class="fa fa-plus"></i>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
        <div class="modal-content card-accent-success">
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    <select name="adjCostcntr" id="adjCost" onchange="adjustmentSel(this.value)"
                        class="form-control form-control-md" placeholder="Cost Center">
                        <option value="">Cost Centers</option>
                        <option value="LABOR">Laboratory</option>
                        <option value="RADIO">Radiology</option>
