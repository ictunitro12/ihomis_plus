...
table#MeaslesTable.dataTable tbody tr:hover {
...
<div class="card card-accent-success">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-auto">
				<div class="btn-group pull-right" role="group" aria-label="">
					<a href="<?php echo site_url('Measles/PatientForm'); ?>" data-toggle="tooltip" title="Register Patient" class="btn btn-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i>
					</a>
	...
	<div class="card-body table-responsive">
		<table id="MeaslesTable" class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
...
<form name="frmMeaslesPDF" id="frmMeaslesPDF" method="post">
	<div class="modal fade" id="ModalMeasles" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
			<div class="modal-content card-accent-success">
				<div class="modal-header">
					<input name="code" id="code" type="hidden">
					<h2 class="modal-title text-success"><i class="fa fa-heartbeat"></i>&nbsp; Measles</h2>
				</div>
				<div class="modal-body border-success" id="MeaslesPDF">
...
<script src="<?php echo base_url() ?>assets/scripts/measles/delete.js"></script>
...
<script type="text/javascript">
	...
	function PatientLogList() {
		var data = new Object();
		data.id = "MeaslesTable";
		/* data.link = baseURL + "Measles/Measles_DataLoad/" + from + "/" + to; */
		data.link = baseURL + "Measles/Measles_DataLoad";
		data.type = "POST";
		data.coldef = [{
				targets: [0],
				visible: false,
	...
	$("#MeaslesTable").on("click", ".ModalDeleteMeasles", function() {
		var data = $(this).data();
		console.log(data);
		$('#DeleteMeasles').modal('show');
		$("#formIdentification").val('delete');
		$("#deletecode").val(data['enccode']);
	});

	$("#MeaslesTable").on("click", ".ModalMeasles", function() {
		var base_url = $('#base_url').val();
		var data = $(this).data();
		console.log(data);
		$('#ModalMeasles').modal('show');
		...
		$('#MeaslesPDF').html('<embed src="' + base_url + "Measles/MeaslesForm/" + enccode + "/" + hpercode + '" frameborder="2" width="100%" height="800px" id="MeaslesPDF">');
	});
</script>