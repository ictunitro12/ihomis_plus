...
<body>
<a class="btn btn-primary" href="<?php echo site_url('Religion/Create');?>">Add</a>

<table id="Religion" class="table table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
                <th width="80px">Religion Code</th>
				<th>Religion Name</th>
...
<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#Religion").dataTable({
					...
					paging: true,
					autoWidth: true,
                    ajax: {"url": "<?php echo base_url();?>index.php/Religion/Religion_list", "type": "POST"},
                 	columnDefs: 
					[
				    {
					targets : [2],
