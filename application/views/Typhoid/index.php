...
table#TyphoidTable.dataTable tbody tr:hover {
  background-color: #80DB88;
		...
		<div class="card card-accent-success">
			...
			<a href="<?php echo site_url('Typhoid/PatientForm');?>" data-toggle="tooltip" title="Add" class="btn btn-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i>
			</a><!-- 
			...
			<table id="TyphoidTable" class="table table-sm table-striped  table-bordered table-condensed table-hover ">
				<thead>
					<tr class="thead-dark">
		...
		<form name ="frmTyphoidPDF" id="frmTyphoidPDF" method="post">
		<div class="modal" id="ModalTyphoid" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
		<div class="modal-content card-accent-success">
		<div class="modal-header">
			<input name="code" id ="code" type="hidden">

		<h2 class="modal-title text-success"><i class="fa fa-heartbeat"></i>Typhoid and Paratyphoid Fever (ICD 10 Code: A01)</h2>
		</div>
		<!-- <div class="modal-body border-success" id="TyphoidPDF"> -->
		<div class="modal-body border-success">
		
		<embed id="TyphoidPDF" type="application/pdf" frameborder="2" width="100%" height="800px">
	...
	<form name="frmDeleteTyphoid" id="frmDeleteTyphoid">
		...
		<div class="modal fade" id="DeleteTyphoid" role="dialog">
	...
	<form id = "frmCSS">
			<div class="modal fade" id="ModalCSS" tabindex="-1" role="dialog">
			  <div class="modal-dialog modal-lg" role="dialog">
				 <div class="modal-content">
					<div class="modal-body">
					   <h3 class="modal-title text-success"><i class="fa fa-heartbeat"></i> Typhoid</h3>
	...
	<script src="<?php echo base_url()?>assets/scripts/typhoid/delete.js"></script>
	<script src="<?php echo base_url()?>assets/scripts/typhoid/typhoid.js"></script>
		...
		{
		/* TyphoidList($.session.get('from'),$.session.get('to')); */
		TyphoidList();
