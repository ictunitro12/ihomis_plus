	...
	<div class="card-header">
		...
		<div class="col-md-6 col-md-auto">
			<div class="btn-group pull-right" role="group" aria-label="">
				<a class="btn btn-success" href="<?php echo site_url('GenericCoreList/Create');?>"><i class="fa fa-plus"></i></a>
			</div>
		</div>	
		</div>
	</div>
...
<table id="GenericCoreList" class="table table-sm table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
...
<script type="text/javascript">
	...
	{
		var data = new Object();
		data.id = "GenericCoreList";
		data.link = "<?php echo site_url('GenericCoreList/GenericCoreList_list');?>";
		data.type = "POST";
		data.coldef =[
		{	
			targets: [2],
