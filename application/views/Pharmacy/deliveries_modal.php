...
<!-- ROMEL : START : DELIVERIES ADD MODAL -->
<div class="modal" id="ModalPharmacyDeliveriesAdd" tabindex="-1" role="dialog" style="overflow: auto;">
	<div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
		<div class="modal-content">
			<div class="modal-header bg-success" style="cursor: move;">
				<h5 class="modal-title text-white" >Deliveries Add</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="clearAddDeliveriesModal()">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form id="process_add_deliveries">
					<div class="row">
						<div class="col-md-12">
							<table class="w-100 text-nowrap">
								<tr>
									<td><label class="text-muted">Delivery No.</label></td>
									<td><input type="text" class="form-control mb-1" name="delno" id="delno_add" /></td>
								</tr>
								<tr>
									<td><label class="text-muted">Delivery Date</label></td>
									<td><input type="date" class="form-control mb-1" name="deldteas" id="deldteas_add" /></td>
								</tr>
								<tr>
									<td><label class="text-muted">Supplier</label></td>
									<td><select class="form-control mb-1" name="wardcode" id="wardcode_add"></select></td>
								</tr>
								<tr>
									<td><label class="text-muted">Item Type</label></td>
									<td><select class="form-control mb-1" name="itemtype" id="itemtype_add"></select></td>
								</tr>
								<tr>
									<td><label class="text-muted">Item Description</label></td>
									<td><select class="form-control mb-1" name="delivery_dmdcomb" id="delivery_dmdcomb_add"></select></td>
								</tr>
								<tr>
									<td><label class="text-muted">Qty. Delivered</label></td>
									<td><input type="text" class="form-control mb-1" name="delqty" id="delqty_add"/></td>
								</tr>
								<tr>
									<td><label class="text-muted">Expiration Date</label></td>
									<td><input type="date" class="form-control mb-1" name="expiredte" id="expiredte_add" /></td>
								</tr>
								<tr>
									<td><label class="text-muted">Type of Account</label></td>
									<td><select class="form-control mb-1" name="itemcode" id="itemcode_add"></select></td>
								</tr>
								<tr>
									<td><label class="text-muted">Delivery Type</label></td>
									<td><select class="form-control" name="suplind" id="suplind_add"></select></td>
								</tr>
							</table>	
						</div>
					</div>
