            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="clearfix">
                        ...
                        <button type="button" id="btnMultipledrug" class="btn btn-outline-success btn-md float-right"><i
                                class="fa fa-search"></i>&nbsp Search Drug/s</button>
                    </div>
                    <div class="mb-2"></div>
...
<?php $this->load->view('Pharmacy/_accountTable.php');?>
<script src="<?php echo base_url()?>assets/scripts/pharmacy/stock.js"></script>
<script src="<?php echo base_url()?>assets/scripts/pharmacy/drugListMultiple.js"></script>
<script src="<?php echo base_url()?>assets/scripts/pharmacy/_accountTable.js"></script>
<script src="<?php echo base_url()?>assets/scripts/pharmacy/saveDelivery.js"></script>
