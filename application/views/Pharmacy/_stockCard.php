    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="input-group mb-2">
                <input type="text" class="form-control" id="drug" readonly placeholder="Drugs & Medicine">
...
<table id="stockcardtbl" class="table table-sm table-striped table-bordered  table-hover" width="100%">
    <thead>
        <tr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <table id="drugData" style="cursor:pointer;"
...
<script>
    $( "#frmFilterDrug" ).submit(function( event ) {
