<div class="row">
	<div class="col-md-12">
		...
		<form id="frmMedicalCertDiscPDF" name="frmMedicalCertDiscPDF" method="post">
			<div class="card card-accent-success">
				<div class="card-header">
					<div class="row">
						<div class="col-md-6 col-md-auto">
							<div class="h3 text text-success">
								<h4 class="modal-title text-success"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;Medical Certificate - Discharge</h4>
							</div>
						</div>
						<div class="col-md-6 col-md-auto">
				...
				<div class="card-body" id="MedicalCertDiscPDF"></div>
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="col-md-12" align="center">
							<a href="javascript:void(0)"  id="certdisclink" data-toggle="tooltip" data-placement="top"  class="btn btn-success btn-md  btn-ladda" data-style="zoom-in">OK</a>
...
<form name="frmRequest"   id="frmRequest">
	...
	<div class="modal" id="ModalRequestDisc" tabindex="-1" role="dialog">
...
<input name="module" id="module" type="hidden" value="medicalcertdisc">
...
<script src="<?php echo base_url()?>assets/scripts/medicalcertdisc/medicalcertdisc.js"></script>
