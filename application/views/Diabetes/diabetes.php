...
table#DiabetesTable.dataTable tbody tr:hover {
  background-color: #80DB88;
	...
	<div class="card-header">
		...
		<a href="<?php echo site_url('Diabetes/PatientForm');?>" data-toggle="tooltip" title="Register Patient" class="btn btn-outline-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i> &nbsp; Patient Register
	...
	<div class="card-body table-responsive">
		<table id="DiabetesTable"  class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
			<thead>
				<tr>
					<th>enccode</th>
					<th>PATIENT ID</th>
					...
					<th>SEX</th>
					<th>BIRTH DATE</th>
					<th>HISTORY <br>(TYPE OF DIABETES)</th>
					<th width="80px"></th>
				</tr>
			</thead>
			<tfoot>
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<ul class="list-group">
						...
						<!-- <li class="list-group-item">
							<b class="text text-success"><i class="fa fa-calendar"></i>&nbsp Type of Diabetes:</b>
							<a class="pull-right text text-success" id="type_diabet">N/A</a>
							<a class="pull-right text text-success" id="other_type">N/A</a>
						</li>
						<li class="list-group-item">
							<b class="text text-success"><i class="fa fa-calendar"></i>&nbsp; Current Treatment :</b>
							<a class="pull-right text text-success" id="med">N/A</a>
							<a class="pull-right text text-success" id="med_1">N/A</a>
							<a class="pull-right text text-success" id="med_2">N/A</a>
							<a class="pull-right text text-success" id="comply">N/A</a>
						</li> -->
						<li class="list-group-item">
...
<form name="frmDeleteDiabetes" id="frmDeleteDiabetes">
	...
	<form name ="frmDiabetesPDF" id="frmDiabetesPDF" method="post">
	<div class="modal" id="ModalDiabetes" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
	<div class="modal-content card-accent-success">
	<div class="modal-header">
		<input name="code" id ="code" type="hidden">
	<h2 class="modal-title text-success"><i class="fa fa-heartbeat"></i>Diabetes Registry Form</h2>
	</div>
	<div class="modal-body border-success" id="DiabetesPDF">
	
		<!--embed src="" frameborder="2" width="100%" height="800px" id="DiabetesPDF" -->
	...
	<input name="enccode" id ="enccode" type="hidden">
 	<script src="<?php echo base_url()?>assets/scripts/diabetes/delete.js"></script> 
<script src="<?php echo base_url()?>assets/scripts/diabetes/diabetes.js"></script>
<script src="<?php echo base_url()?>assets/scripts/diabetes/diab.js"></script>
