...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#formIden').val('update');
		initDiabetesEdit(enccode,hpercode);
...
<script src="<?php echo base_url() ?>assets/scripts/diabetes/diabetess.js"></script>
<script src="<?php echo base_url() ?>assets/scripts/diabetes/diabetes_validation.js"></script>
