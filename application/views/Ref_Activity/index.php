...
table#ActivityTable.dataTable tbody tr:hover {
  background-color: #80DB88;
	...
	<div class="card card-accent-success">
			...
			<div class="row">
				...
				<div class="col-md-6 col-md-auto">
					<div class="btn-group pull-right" role="group" aria-label="">
						<button onclick="AddActivity()" class="btn btn-outline-success btn-md btn-ladda" data-style="zoom-in" data-original-title="Add Activity" data-toggle="tooltip"><i class="fa fa-plus"> </i> Add Activity
						</button>
					</div>
				</div>	
			</div>	
		...
		<div class="card-body table-responsive">
			<table id="ActivityTable"  class="table table-sm table-striped  table-bordered table-condensedtable-hover" width="100%">
				<thead>
					<tr>
	...
	<form name="frmActivity"   id="frmActivity">
		<div class="modal fade" id="ModalAddActivity" tabindex="-1" role="dialog">
	...
	<form name="frmDeleteActivity" id="frmDeleteActivity">
	...
	<script type="text/javascript">
		...
		{
			var data = new Object();
			data.id = "ActivityTable";
			data.link = "<?php echo site_url('Ref_Activity/ActivityList');?>";
			data.type = "POST";
			data.coldef=[
			{
				targets : 2,
...
<script src="<?php echo base_url()?>assets/scripts/ref_activity/ref_activity_validation.js"></script>
<script src="<?php echo base_url()?>assets/scripts/ref_activity/delete.js"></script>
