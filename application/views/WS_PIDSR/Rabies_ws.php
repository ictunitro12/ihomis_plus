...
<div class="card card-accent-success">
	...
	<div class="card-body table-responsive">
		<form name="rabies_form" id="rabies_form" method="post">
			<input type="hidden" class="form-control form-control-sm mb-1" name="ttokens" id="ttokens" autocomplete="off" />
			<input type="hidden" class="form-control form-control-sm mb-1" name="pidsrmodule" id="pidsrmodule" value="rabies" autocomplete="off" />
			<table id="ws_RabiesTbl" class="table table-responsive-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr align="center">
...
<script src="<?php echo base_url() ?>assets/scripts/ws_pidsr/rabies.js"></script>