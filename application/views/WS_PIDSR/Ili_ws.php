...
<div class="card card-accent-success">
	...
	<div class="card-body table-responsive">
		<form name="ili_form" id="ili_form" method="post">
			<input type="hidden" class="form-control form-control-sm mb-1" name="ttokens" id="ttokens" autocomplete="off" />
			<input type="hidden" class="form-control form-control-sm mb-1" name="pidsrmodule" id="pidsrmodule" value="ili" autocomplete="off" />
			<table id="ws_IliTbl" class="table table-responsive-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr align="center">
					...
					<div id="mySubmitProgress">
						...
						<div align="center">
							<label class="text-success"><b>
									<br>
									<h6>Sending Influenza-like illness Data &nbsp;&nbsp;
...
<script src="<?php echo base_url() ?>assets/scripts/ws_pidsr/ili.js"></script>