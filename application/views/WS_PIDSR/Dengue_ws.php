...
<div class="card card-accent-success">
	...
	<div class="card-body table-responsive">
		<form name="dengue_form" id="dengue_form" method="post">
			<input type="hidden" class="form-control form-control-sm mb-1" name="ttokens" id="ttokens" autocomplete="off" />
			<input type="hidden" class="form-control form-control-sm mb-1" name="pidsrmodule" id="pidsrmodule" value="dengue" autocomplete="off" />
			<table id="ws_DengueTbl" class="table table-responsive-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr align="center">
...
<script src="<?php echo base_url() ?>assets/scripts/ws_pidsr/dengue.js"></script>