...
<!-- 
			      ...
			      <div class="modal-content">
			        <div class="modal-body">
 					...
 					<div class="form-row">
							...
							<div class="col-md-6">
								<input type="text"  class="form-control form-control-mb" autocomplete="off" id="certno" name="certno"  placeholder = "CERTIFICATE NUMBER" value="202000000001">
							</div>
						</div>	
						<div class="form-row">
	...
	<script src="<?php echo base_url()?>assets/scripts/Rep_MedRecReport/medicolegalall.js"></script>
	<script src="<?php echo base_url()?>assets/scripts/Rep_MedRecReport/medico_validation.js"></script>
