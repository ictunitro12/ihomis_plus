			...
			<div class="row">
				...
				<div class="col-md-6 col-md-auto">
					<div class="btn-group pull-right" role="group" aria-label="">
						<button onclick="AddSupplier()" class="btn btn-outline-success btn-md btn-ladda" data-style="zoom-in" data-original-title="Add Activity" data-toggle="tooltip"><i class="fa fa-plus"> </i> Add Activity
						</button>
					</div>
				</div>	
			</div>	
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">	
							...
							<div class="col-md-3 col-form-label text-default mb-1">Supplier Name:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="name" name="name" placeholder ="Name" maxlength="100">
							</div>
							<div class="col-md-3 col-form-label text-default mb-1">Owners Name:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="owner" name="owner" placeholder ="Owners Name" maxlength="100">
							</div>	
							<div class="col-md-3 col-form-label text-default mb-1">Address:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="addr" name="addr" placeholder ="Address" maxlength="100">
							</div>	
							<div class="col-md-3 col-form-label text-default mb-1"> Telephone:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="telno" name="telno" placeholder ="Telephone" maxlength="7">
							</div>
							<div class="col-md-3 col-form-label text-default mb-1"> Telephone No:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="telno2" name="telno2" placeholder ="Telephone No" maxlength="7">
							</div>	
							<div class="col-md-3 col-form-label text-default mb-1"> Local No:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="localno" name="localno" placeholder ="Local No" maxlength="20">
							</div>			
							<div class="col-md-3 col-form-label text-default mb-1"> Fax Number:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="faxno" name="faxno" placeholder ="Fax Number" maxlength="7">
							</div>	
							...
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="tax" name="tax" placeholder ="Tax Identification Number" maxlength="20">
							</div>
							<div class="col-md-3 col-form-label text-default mb-1">VAT:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="vat" name="vat" placeholder ="VAT" maxlength="20">
							</div>								
