...
<body>
<a class="btn btn-primary" href="<?php echo site_url('Salt/Create');?>">Add</a>

<table id="Salt" class="table table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
                <th width="80px">Salt Code</th>
				<th>Salt Name</th>
...
<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#Salt").dataTable({
					...
					paging: true,
					autoWidth: true,
                    ajax: {"url": "<?php echo base_url();?>index.php/Salt/Salt_list", "type": "POST"},
                 	columnDefs: 
					[
				    {
					targets : [2],
