...
<title>TransferFee</title>
</head>
<body>
<a class="btn btn-primary" href="<?php echo site_url('TransferFee/Create');?>">Add</a>

<table id="TransferFee" class="table table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
                <th width="80px">Date as of</th>
				<th>Rate</th>
...
<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#TransferFee").dataTable({
					...
					paging: true,
					autoWidth: true,
                    ajax: {"url": "<?php echo base_url();?>index.php/TransferFee/TransferFee_list", "type": "POST"},
                 	columnDefs: 
					[
				    {
					targets : [2],
