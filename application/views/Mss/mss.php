...
<script type="text/javascript">
	$(function()
	{
		...
		initMsswizard(enccode,hpercode);
...
<script src="<?php echo base_url()?>assets/scripts/mss/assessment_validation.js"></script><!--checkbox-->
<script src="<?php echo base_url()?>assets/scripts/mss/delete.js"></script><!--checkbox-->
<script src="<?php echo base_url()?>assets/scripts/mss/mss_validation.js"></script><!--checkbox-->
<script src="<?php echo base_url()?>assets/scripts/mss/mss_fam.js"></script><!--family-->
