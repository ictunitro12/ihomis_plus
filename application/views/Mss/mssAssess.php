...
<div>
	...
	<div class="card card-body bg-secondary">
		...
		<div class="form-row">
			...
			<div class="form-row">
				<label class="col-md-2 col-form-label text-default mb-1">Ocupation:</label>
				<div class="col-md-4">
				...
				<div class="col-md-5">
					<input type="text"  class="form-control  form-control-mb mb-1" placeholder = "Income" id="ass_income" name="ass_income">
			...
			<div class="form-row">
				...
				<div class="col-md-5">
					<input type="text"  class="form-control  form-control-mb mb-1" placeholder = "Per Capital Income" id="ass_perIncome" name="ass_perIncome">
			...
			<div class="form-row">
				<label class="col-md-2 col-form-label text-default mb-1">Category :</label>
					...
					<div class="col-md-4">
						<select  name="ass_IOE" id="ass_IOE"  class="form-control form-control-mb" >
						<option value="">Select</option> 
		...
		<div class="form-row">
			...
			<div class="form-row">
				...
				<div class="col-md-5">
					<input type="text"  class="form-control  form-control-mb mb-1" placeholder = "Household Size" id="ass_houSize" name="ass_houSize">
				</div>
			</div>
			<div class="form-row">	
				<label class="col-md-2 col-form-label text-default mb-1">Monthly Expenses:</label>
				<div class="col-md-4">
					<input type="text"  class="form-control  form-control-mb mb-1" placeholder = "Monthly Expenses" id="ass_monExp" name="ass_monExp">
				</div>
				<label class="col-md-1 col-form-label text-default mb-1">House/Lot:</label>
				<div class="col-md-5">
					<input type="text"  class="form-control  form-control-mb mb-1" placeholder = "House/Lot" id="ass_hoLot" name="ass_hoLot">
				</div>
			</div>
		...
		<div class="form-row">
			...
			<div class="form-row">
				...
				<div class="col-md-1">
					<input type="number"  class="income form-control  form-control-mb mb-1" placeholder = "Food" autocomplete="off" id="ass_food" name="ass_food" onkeyup="sum();">
				</div>
				<label class="col-md-2 col-form-label text-default mb-1">Educational:</label>
				<div class="col-md-2">
					<input type="number"  class="income form-control  form-control-mb mb-1" placeholder = "Educational" autocomplete="off" id="ass_educ" name="ass_educ" onkeyup="sum();">
				</div>
				...
				<div class="col-md-2">
					...
					" autocomplete="off" id="ass_transpo" name="ass_transpo" onkeyup="sum();">
				</div>
				<label class="col-md-1 col-form-label text-default mb-1">Clothing:</label>
				<div class="col-md-1">
					<input type="number"  class="income form-control  form-control-mb mb-1" placeholder = "Clothing" autocomplete="off" id="ass_cloth" name="ass_cloth" onkeyup="sum();">
				</div>
			...
			<div class="form-row">
				...
				<div class="col-md-1">
					<input type="number"  class="income form-control  form-control-mb mb-1" placeholder = "Househelp" autocomplete="off" id="ass_houHelp" name="ass_houHelp" onkeyup="sum();">
				</div>
				<label class="col-md-2 col-form-label text-default mb-1">Medical Expenditure:</label>
				<div class="col-md-2">
					<input type="number"  class="income form-control  form-control-mb mb-1" placeholder = "Medical Expenditure" autocomplete="off" id="ass_medExp" name="ass_medExp" onkeyup="sum();">
				</div>
				...
				<div class="col-md-2">
					...
					" autocomplete="off" id="ass_insPre" name="ass_insPre" onkeyup="sum();">
				</div>
				<label class="col-md-1 col-form-label text-default mb-1">Other:</label>
				<div class="col-md-1">
					<input type="number"  class="income form-control  form-control-mb mb-1" placeholder = "Other" autocomplete="off" id="ass_other" name="ass_other" onkeyup="sum();">
				</div>
...
<script src="<?php echo base_url()?>assets/scripts/mss/mssFamily.js"></script>
<script src="<?php echo base_url()?>assets/scripts/mss/delete_family.js"></script>
...
<script type="text/javascript">
	  ...
	  function MssFamily()
  {
    ...
    var enc = atob('<?php echo $this->uri->segment(3);?>');
    var enccode = encodeURIComponent(encodeURIComponent(enc));

    var data = new Object();
    data.id = "tblMssfamily";
    data.link = "<?php echo site_url('MSS/MssFamily/');?>" + enccode;
    data.type = "POST";
  ...
  $(".ModalAddFamily").on('click',function(){
    ...
    $("#addenccode").val(enccode);
    $("#addhpercode").val(hpercode);


    var obj= getID(enccode);
			var i;
				for (i = 1; i <= obj['seqid']; i++) {
				  $("#famseqid").val(i);
				}
	    console.log(i);
  });
 ...
 function getID(){
    ...
    function getFamilyComposition(enccode,hpercode,seqid){
        ...
        $.ajax({
            type: "POST",
            url: baseURL+"MSS/getFamilyComposition/"+ enccode + "/"+hpercode+ "/" + seqid  ,
            data: "JSON",
            async:false,
            success: function(data,status){ 
                obj = $.parseJSON(data);
