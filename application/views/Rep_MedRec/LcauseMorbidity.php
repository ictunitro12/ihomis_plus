...
$(document).ready(function()
	...
	$('#filter').on('click',function(){
		...
		{
	    window.open(baseURL+"Rep_MedicalRecords/LeadCausesMorbidity/monthly/"+$("#mnth").val(),'name'); 
		}
		else if($("#quarterly").prop('checked') == true)
		{
		var year = $("#qyear").val();
	    window.open(baseURL+"Rep_MedicalRecords/LeadCausesMorbidity/quarterly/"+$("#squarter").val()+year); 
		}else if($("#annual").prop('checked') == true){
			var year = $("#qyear").val();
			window.open(baseURL+"Rep_MedicalRecords/LeadCausesMorbidity/yearly/"+year); 
		}
	});	
	</script>		
