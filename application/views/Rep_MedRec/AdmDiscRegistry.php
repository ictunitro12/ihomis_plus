...
<div class="card card-accent-success">
	<div class="card-header">
		...
		<a id="printopd" href="<?php echo site_url('Rep_MedRec/AdmDischReg/');?>" data-toggle="tooltip" title="Print Preview" class="btn btn-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-search-plus"></i>
		</a>
			</div>
		</div>	
	</div>
	...
	<table id="Admtbl" class="table table-sm table-striped table-borderless table-condensed ">
		...
		<table id="Labtbl" class="table table-sm table-striped table-borderless table-condensed ">
		<thead class="thead-dark">	
			<thead class="thead-dark" align="center">
				<tr>
				<th>HOSPITAL NUMBER</th>
		...
		<table id="Xraytbl" class="table table-sm table-striped table-borderless table-condensed ">
		<thead class="thead-dark">	
			<thead class="thead-dark" align="center">
			<tr>
				<th>HOSPITAL NUMBER</th>
		...
		<table id="Operatbl" class="table table-sm table-striped table-borderless table-condensed ">
		<thead class="thead-dark">	
			<thead class="thead-dark" align="center">
			<tr>
				<th>HOSPITAL NUMBER</th>
...
<form id="dateRange" method="post">
	...
	<script src="<?php echo base_url()?>assets/scripts/Rep_MedRecReport/admdiscreg.js"></script>
