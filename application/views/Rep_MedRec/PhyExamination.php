<div class="row">
	...
	<div class="col-md-6">
		...
		<form name ="frmphyexam_form" id="frmphyexam_form" method="post">
				<div class="modal" id="ModalPhysicalExam" tabindex="-1" role="dialog">
				<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
				<div class="modal-content card-accent-success">
				<div class="modal-header">
				...
				<div class="modal-body border-success">
				<embed id="physicalexam" type="application/pdf" frameborder="2" width="100%" height="800px">
				</div>
		...
		<!-- <form id="frmFollowRep" method="post">
			...
			<input  type="hidden" name="Toecode" id="Toecode">
		...
		<form name="frmNotFound" id="frmNotFound">
	...
	<script src="<?php echo base_url()?>assets/scripts/Rep_MedRecReport/phyexam.js"></script>
