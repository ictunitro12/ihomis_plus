	...
	<div class="col-md-6">
		...
		<form name="frmRoom" id="frmRoom">
			...
			<input  type="hidden" name="Hpercode" id="Hpercode">
				<div class="modal fade" id="Room" tabindex="-1" role="dialog">
					<div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
						<div class="modal-content">
							<div class="modal-header bg-success">
								<h5 class="modal-title text-white" >Room</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
							<div class="modal-body">
								<h4>Patient not yet admitted.</h4>
							</div>
							<div class="modal-footer bg-secondary">
...
<!-- 
	...
	<script src="<?php echo base_url()?>assets/scripts/Rep_MedRecReport/certconfinement.js"></script>
