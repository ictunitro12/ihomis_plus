				...
				<div class="col-md-6">
						<div class="btn-group pull-right" role="group" aria-label="">
						    <button type="button" class="btn btn-success pull-right btn-md" data-toggle="modal" data-target="#DateSearch" title="Select Date">
	               			 ...
	               			 <button type="button" id="printadmittedpdf" class="btn btn-success pull-right btn-md" data-style="zoom-in" title="Print PDF"><i class="fa fa-file-pdf-o"></i>
	               			 </button>
			    		</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function AdmitPatReportList(from,to)
	{
		$.ajax({
		url: baseURL + "Rep_Admission/admittedPatientReport/"+from+'/'+to,
		type:"POST",
		data: "JSON",
		dataType: "JSON",
		processData:false,
		...
		success: function(data,response){
			...
			var x = document.getElementById("printadmittedpdfmodal").src = baseURL+"Rep_Admission_pdf/AdmittedPatientRep/"+from+"/"+to;
			});
