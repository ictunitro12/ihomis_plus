...
<script type="text/javascript">
	...
	function AdmPatSecList(from,to)
	{
		$.ajax({
		url: baseURL + "Rep_Admission/AdmitPatient_Sec/" + from +'/'+to,
		type:"POST",
		data: "JSON",
		dataType: "JSON",
		processData:false,
		...
		success: function(data,response){
			...
			var x = document.getElementById("printadmittedpdfmodal").src = baseURL+"Rep_Admission_pdf/AdmittedPatSec_pdf/"+from+"/"+to;
			});
