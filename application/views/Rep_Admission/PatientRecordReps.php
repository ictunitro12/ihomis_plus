			...
			<div class="row">
				<div class="col-md-6 col-md-auto">
					<div class="h3 text text-success">
						<h4 class="modal-title text-success"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;Patient Record Report</h4>
					</div>
				</div>
				<div class="col-md-6 col-md-auto">
...
<script src="<?php echo base_url()?>assets/scripts/admissionreports/patient_information.js"></script>
