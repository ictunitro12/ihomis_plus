	...
	<div class="card-header">
		...
		<div class="col-md-6 col-md-auto">
			<div class="btn-group pull-right" role="group" aria-label="">
				<a class="btn btn-success" href="<?php echo site_url('Packaging/Create');?>"><i class="fa fa-plus"></i></a>
			</div>
		</div>	
		</div>
	</div>
...
<table id="Packaging" class="table  table-sm table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
                <th>Code</th>
				<th>Description</th>
...
<script type="text/javascript">
	...
	function PackagingList()
	{
		var data = new Object();
		data.id = "Packaging";
		data.link = "<?php echo site_url('Packaging/Packaging_list');?>";
		data.type = "POST";
		data.coldef =[
		{	
			targets: [2],
