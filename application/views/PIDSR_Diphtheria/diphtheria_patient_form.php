...
<input name="module" id="module" type="hidden" value="diphtheria">
...
<div class="card card-accent-success">
	<div class="card-header">
		<div class="row">
			<div class="col-md">
				<h4 class="card-title text-success"><i class="fa fa-user-circle-o"></i>&nbsp; Diphtheria (ICD 10 Code: A36)</h4>
			</div>
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-row">
					...
					<div class="col-md-4">
						<input type="text" class="form-control form-control-md" id="info_occu" name="info_occu" placeholder="Occupation" disabled>
					</div>
					...
					<div class="col-md-4">
						<input type="text" class="form-control form-control-md" id="info_mobno" name="info_mobno" placeholder="Telephone" disabled>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="form-row">
			...
			<div class="col-md-2">
				<input type="datetime-local" class="form-control form-control-md mb-1" step="any" id="date_admitted" name="date_admitted">
			</div>
			...
			<div class="col-md-2">
				<select class="form-control form-control-md mb-1" name="outcome" id="outcome">
					...
					<option value="HAMA">Home agains medical advice</option>
				</select>
			</div>
		...
		<div class="form-row">
			...
			<div class="col-md-4">
				<input type="text" class="form-control form-control-md mb-1" id="caregiver" name="caregiver">
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">Contact Nos.:</label>
			<div class="col-md-5">
				<input type="text" class="form-control form-control-md mb-1" id="caregiver_no" name="caregiver_no">
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-1 col-form-label text-default mb-1">Date of Report:</label>
			<div class="col-md-2">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="date_report" name="date_report">
			</div>
			<label class="col-md-2 col-form-label text-default mb-1">Name of Report:</label>
			<div class="col-md-3">
				<input type="text" class="form-control form-control-md mb-1" id="reporter" name="reporter">
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">Contacct Nos.:</label>
			<div class="col-md-3">
				<input type="text" class="form-control form-control-md mb-1" id="reporter_no" name="reporter_no">
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">Date of Investigation:</label>
			<div class="col-md-2">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="date_investigation" name="date_investigation">
			</div>
			<label class="col-md-2 col-form-label text-default mb-1">Name of investigator/s: </label>
			<div class="col-md-3">
				<input type="text" class="form-control form-control-md mb-1" id="investigator" name="investigator">
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">Contacct Nos.:</label>
			<div class="col-md-3">
				<input type="text" class="form-control form-control-md mb-1" id="investigator_no" name="investigator_no">
			</div>
		</div>
		<hr class="bg-success">
		<div class="row">
			<div class="col-md-12">
				<div class="h5 text-success"><i class="fa fa-file-text-o"></i>&nbsp BACKGROUND INFORMATION</div>
			</div>
		</div>
		<hr class="bg-success">
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">Diphtheria-containing vaccine doses:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="diphtheria_dosey" name="diphtheria_dose" value="Y">&nbsp; Yes
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="diphtheria_dosen" name="diphtheria_dose" value="N">&nbsp; No
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">If Yes, Number of total doses:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_dose0" name="total_dose" value="0">&nbsp; Zero
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_dose1" name="total_dose" value="1">&nbsp; 1
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_dose2" name="total_dose" value="2">&nbsp; 2
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_dose3" name="total_dose" value="3">&nbsp; 3
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_doseu" name="total_dose" value="U">&nbsp; Unknown
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">Date of last vaccination:</label>
			<div class="col-md-4">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="date_last_vaccination" name="date_last_vaccination">
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">Source of information:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="sourceinformationc" name="sourceinformation" value="CARD">&nbsp; Card
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="sourceinformationr" name="sourceinformation" value="RECALL">&nbsp; Recall
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="sourceinformationt" name="sourceinformation" value="TCL">&nbsp; TCL
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">Known Exposure to:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_dose0" name="known_exposure" value="CON">&nbsp; Confirmed case
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_dose1" name="known_exposure" value="PROB">&nbsp; Probable case
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="total_dose2" name="known_exposure" value="CAR">&nbsp; Carrier
			</div>
			<div class="col-md-2 col-form-label">
				<input type="radio" id="total_dose3" name="known_exposure" value="TRAV">&nbsp; International traveler
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">Other means of exposure:</label>
			<div class="col-md-4">
				<input type="text" class="form-control form-control-md mb-1" id="exposure_other" name="exposure_other">
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">School name, if applicable:</label>
			<div class="col-md-4">
				<input type="text" class="form-control form-control-md mb-1" id="name_school" name="name_school">
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-3 text-default mb-1">Any travel within 14 days before onset of illness:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="travel14daysy" name="travel14days" value="Y">&nbsp; Yes
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="travel14daysn" name="travel14days" value="N">&nbsp; No
			</div>
			<label class="col-md-2 col-form-label text-default mb-1">if yes where (in detail):</label>
			<div class="col-md-5">
				<input type="text" class="form-control form-control-md mb-1" id="traveldetail" name="traveldetail">
			</div>
		</div>
		<hr class="bg-success">
		<div class="row">
			<div class="col-md-12">
				<div class="h5 text-success"><i class="fa fa-file-text-o"></i>&nbsp; CLINCAL DETAILS</div>
			</div>
		</div>
		<hr class="bg-success">
		<div class="form-row">
			<label class="col-md-3 col-form-label text-default mb-1"><i class="fa fa-asterisk text-danger"></i> Date onset of fever and / or sore throat:</label>
			<div class="col-md-4">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="date_onset" name="date_onset">
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">Check Signs/Symptoms which apply:</label>
			<div class="col-md-7 col-form-label">
				<input type="checkbox" id="fever" name="fever">&nbsp; Fever &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="sorethroat" name="sorethroat">&nbsp; Sore throat &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="swallowing" name="swallowing">&nbsp; Difficulty of swallowing &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="breathing" name="breathing">&nbsp; Difficulty of breathing &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="cough" name="cough">&nbsp; Cough &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="pseudomembrane" name="pseudomembrane">&nbsp; Pseudomembrane &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="other_symptoms" name="other_symptoms">&nbsp; Others, specify
			</div>
			<input type="text" class="col-md-3 form-control form-control-md mb-1" id="other_symptoms_specify" name="other_symptoms_specify">
		</div>
		<!-- <div class="form-row">
			<label class="col-md-2 col-form-label text-default mb-1">Outcome at discharge :</label>
			<div class="col-md-7 col-form-label">
				<input type="checkbox" id="fever" name="fever">&nbsp; clinically well  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="sorethroat" name="sorethroat">&nbsp; Referred to &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" id="swallowing" name="swallowing">&nbsp; Death (Date died)
			</div>
			<input type="text" class="col-md-3 form-control form-control-md mb-1" id="date_died" name="date_died">
		</div> -->
		<hr class="bg-success">
		<div class="row">
			<div class="col-md-12">
				<div class="h5 text-success"><i class="fa fa-file-text-o"></i>&nbsp;TREATMENT INFORMATION</div>
			</div>
		</div>
		<hr class="bg-success">
		<div class="form-row">
			<label class="col-md-2 text-default mb-1">Administered antibiotic therapy?:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="antibioticy" name="antibiotic" value="Y">&nbsp; Yes
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="antibioticn" name="antibiotic" value="N">&nbsp; No
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="antibioticu" name="antibiotic" value="U">&nbsp; Unknown
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">if yes, Date:</label>
			<div class="col-md-6">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="antibiotic_date" name="antibiotic_date">
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-3 text-default mb-1">Administered Diphtheria Anti toxin (DAT) therapy: </label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="diphtheriatoxiny" name="diphtheriatoxin" value="Y">&nbsp; Yes
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="diphtheriatoxinn" name="diphtheriatoxin" value="N">&nbsp; No
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="diphtheriatoxinu" name="diphtheriatoxin" value="U">&nbsp; Unknown
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">if yes, Date:</label>
			<div class="col-md-5">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="diphtheriatoxin_date" name="diphtheriatoxin_date">
			</div>
		</div>
		<hr class="bg-success">
		<div class="row">
			<div class="col-md-12">
				<div class="h5 text-success"><i class="fa fa-file-text-o"></i>&nbsp;SPECIMEN COLLECTION for Corynebacterium diphtheriae</div>
			</div>
		</div>
		<hr class="bg-success">
		<div class="form-row">
			<label class="col-md-1 col-form-label text-default mb-1">Date of collection:</label>
			<div class="col-md-3">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="datecollection" name="datecollection">
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">Date of sample send:</label>
			<div class="col-md-3">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="datesample" name="datesample">
			</div>
			<label class="col-md-1 col-form-label text-default mb-1">Date of results:</label>
			<div class="col-md-3">
				<input type="datetime-local" class="form-control form-control-md mb-1" id="daterslt" name="daterslt">
			</div>
		</div>
		<div class="form-row">
			<label class="col-md-1 text-default mb-1">Check what applies:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="checkapplies" name="checkapplies" value="P">&nbsp; Positive
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="checkapplies" name="checkapplies" value="N">&nbsp; Negative
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="checkapplies" name="checkapplies" value="U">&nbsp; Undetermined
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="checkapplies" name="checkapplies" value="NP">&nbsp; Not processed
			</div>
			<label class="col-md-1 text-default mb-1">If Positive:</label>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="ifpositivy" name="ifpositiv" value="TOX">&nbsp; Toxigenic
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="ifpositivn" name="ifpositiv" value="NON">&nbsp; Non—toxigenic
			</div>
		</div>
		<hr class="bg-success">
		<div class="row">
			<div class="col-md-2">
				<div class="h5 text-success col-form-label"><i class="fa fa-file-text-o"></i>&nbsp;FINAL CLASSIFICATION</div>
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="final_classisus" name="final_classi" value="SUS">&nbsp; Suspect
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="final_classilab" name="final_classi" value="LAB">&nbsp; Lab confirmed
			</div>
			<div class="col-md-1 col-form-label">
				<input type="radio" id="final_classiepi" name="final_classi" value="EPI">&nbsp; Epi linked
			</div>
			<div class="col-md-3 col-form-label">
				<input type="radio" id="final_classicomp" name="final_classi" value="COMP">&nbsp; Clinically compatible &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" id="final_classidisc" name="final_classi" value="DISC">&nbsp; Discarded
			</div>
		</div>
		<hr class="bg-success">
