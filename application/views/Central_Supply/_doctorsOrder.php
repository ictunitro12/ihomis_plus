    ...
    <form name="frmFilter" id="frmFilter">
        ...
        <div class="shadow-lg p-3 mb-1" style="width: 40rem;">
            ...
            <div class="input-group mb-1">
                ...
                <button class="btn btn-outline-success" id="btnFilter" type="submit"><i
                        class="fa fa-search"></i></button>
            </div>
        </div>
    </form>
</div>
<table id="supplyDocord_tbl" style="cursor:pointer" class="table table-sm  table-bordered table-condensed table-hover"
    width="100%">
    <thead>
        <tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table id="supIssue" style="cursor:pointer"
