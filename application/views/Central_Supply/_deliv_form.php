...
<form id="frmDeleteDeliv" name="frmDeleteDeliv" method="post">
	<div class="modal" id="deleteDeliv" name="deleteDeliv" tabindex="-1" role="form">
  ...
  <div class="modal-content">
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          Purchase Request no:
          <input type="text"  class="form-control form-control-md" name="delReqno" id="delReqno" placeholder ="Request no"/>
          Purchase Order no:
      ...
      <div class="row">
		...
		<div class="col-md-6">
          ...
          <div class="input-group">
             <input type="text" readonly class="form-control form-control-md" placeholder="Item name" name="item" id="item"><button id="btnItem" type="button" class="btn btn-outline-success"><i class="fa fa-search"></i></button>
             <input type="hidden" class="form-control form-control-md" name="cl1comb" id="cl1comb">
             <input type="hidden"  class="form-control form-control-md" name="cl2comb" id="cl2comb">
             <input type="hidden"  class="form-control form-control-md" name="cl2code" id="cl2code">
        ...
        <div class="col-md-6">
          UnitPrice:
          <input  type="text" class="form-control form-control-md" placeholder="Unit Price"  name="uprice" id="uprice">
	    	</div>
      </div>
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
         Serial/Item code :
          <input  type="text" class="form-control form-control-md" name="delItemCode" id="delItemCode" placeholder='Item code'>
        </div>
        <div class="col-md-6">
          Remarks :
...
<script>
	...
	var  POSTURL = baseURL+"Central_Supply/saveDelivery";
		  $.ajax({
			type : "POST",
			url  : POSTURL,
			dataType: "JSON",
  ...
  messages:{
    ...
    delItemCode:'Lot no is required',
  },
	errorElement: 'span',
