                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-1">
                            <input type="datetime-local" id="dateOrderPres" name="dateOrderPres" step="any"
                        ...
                        <div class="col-md-5 mb-1">
                            <input type="datetime-local" id="datePostPres" name="datePostPres" step="any"
                                class="form-control form-control-md" autocomplete="off">
                        </div>
                        <div class="col-md-1 mb-1">
                            Doctor:
					...
					<div class="clearfix mb-1">
						...
						<button type="button" id="btnSearchDrugs"class="btn btn-outline-success float-right"><i class="fa fa-search"></i> &nbsp Search Drugs</button>
					</div>
                    <div class="row">
                        <div class="col-md-12">
                            <table id="medicineList" class="table table-bordered table-hovered table-sm table-condensed table-sm row-border order-column" width="100%">
								<thead class="thead-dark">
                                <tr>
                                    <th class="align-middle text-center" rowspan='2'></th>
									<th lass="align-middle text-center" rowspan='2'></th>
									<th class="align-middle text-center" rowspan='2'></th>
									<th class="align-middle text-center" rowspan='2'>Drugs/Medicines</th>
...
<div class="modal" id="modalPresRX" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h4 class="modal-title text-success"><i class="fa fa-prescription fa-2x"></i> </h4>
                <iframe id="rxDrug_pdf" type="application/pdf" frameborder="2" width="100%" height="500px"></iframe>
            </div>
            <div class="modal-footer">
                <div class="btn-group">
                    <button class="btn btn-outline-danger" data-dismiss="modal"><i class="fa fa-close"></i>
...
<div class="modal" id="modalMultipleDrug" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h4 class="modal-title text-success"><i class="fa fa-prescription fa-2x"></i> </h4>
				<table id="drugmultiData" style ="cursor:pointer;"; class="table table-sm table-striped table-bordered table-condensed table-hover">
					<thead>
						<tr>
							<th>Code</th>
            ...
            <div class="modal-footer">
                <div class="btn-group">
				<button type="button" class="btn btn-outline-success" id="btnSelectDrugs"><i class="fa fa-check"></i>
                        Select</button>
                    <button class="btn btn-outline-danger" data-dismiss="modal"><i class="fa fa-close"></i>
                        Cancel</button>
                </div>
