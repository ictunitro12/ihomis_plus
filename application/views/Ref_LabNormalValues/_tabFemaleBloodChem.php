<div class="tab-pane fade show active" id="FemaleBloodChem" role="tabpanel" aria-labelledby="femalebldexam-tab">
	<div class="row">
		<div class="col-md-8">
			<div class="h5 text text-success">
				<i class="fa fa-tint"></i>
				&nbsp; BLOOD CHEMISTRY (<i class="fa fa-female text-danger"></i> Female)
			</div>
		</div>
		<div class="col-md-4">
...
<!-- form modal -->
<form id="frmBloodChemfemale" method="post">
...
<script src="<?php echo base_url() ?>assets/scripts/reflab_normal_value_tabbing/bldexamfemale.js"></script>
<script src="<?php echo base_url() ?>assets/scripts/reflab_normal_value_tabbing/validation_bldexam_f.js"></script>
<script src="<?php echo base_url() ?>assets/scripts/reflab_normal_value_tabbing/deletebldexam_f.js"></script>