...
<div class="card card-accent-success">
	...
	<div class="card-body">
		...
		<div class="form-row">
			...
			<div class="form-row">
				<label class="col-md-5 col-form-label text-default mb-1"><i class="fa fa-asterisk text-danger"></i> Date of Report:</label>
				<div class="col-md-7">
		...
		<div class="col-md-9">
			...
			<div class="form-row">
				<label class="col-md-1 col-form-label text-default mb-1">Date Report :</label>
				<div class="col-md-3">
					<input type="datetime-local" class="form-control form-control-md mb-1" id="date_died" name="date_died" disabled>
				</div>
				<label class="col-md-1 col-form-label text-default mb-1">Date of Inverstigation :</label>
				<div class="col-md-3">
					<input type="datetime-local" class="form-control form-control-md mb-1" id="date_died" name="date_died" disabled>
				</div>
				<label class="col-md-1 col-form-label text-default mb-1">Mother&#39;s Full Name :</label>
				<div class="col-md-3">
					<input type="text" class="form-control form-control-md mb-1" id="date_died" name="date_died" disabled>
				</div>
				<label class="col-md-1 col-form-label text-default mb-1">Contact Number :</label>
				<div class="col-md-3">
					<input type="text" class="form-control form-control-md mb-1" id="date_died" name="date_died" disabled>
				</div>
			</div>
		...
		<div class="form-row">
			<div class="col-md-6">
				<label class="col-md-12 col-form-label text-default mb-1">In the first 2 days of life, check which applies :</label>
				<label class="col-md-6 col-form-label text-default mb-1">did the baby suck and cry normally? :</label>
				<div class="col-md-6">
					<select name="member_ip" id="member_ip" class="form-control form-control-md">
						<option value="">Select</option>
						<option value="Y">Yes</option>
