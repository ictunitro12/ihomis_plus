<style>
	table#NeonatalTable.dataTable tbody tr:hover {
...
<form method="post">
	<div class="modal" id="ModalNeonatal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-dialog-centered modal-xl" role="dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<embed id="printneonatalpdfmodal" type="application/pdf" frameborder="2" width="100%" height="800px">
				</div>
...
<script src="<?php echo base_url() ?>assets/scripts/pidsr_neonatal/delete.js"></script>
<script src="<?php echo base_url() ?>assets/scripts/pidsr_neonatal/neonatal.js"></script>
...
<script type="text/javascript">
	...
	function PatientLogList() {
		var data = new Object();
		data.id = "NeonatalTable";
		data.link = baseURL + "PIDSR_Neonatal/neonatalList";
		data.type = "POST";
		data.coldef = [{
			targets: [0, 1],
			visible: false,
	...
	$("#NeonatalTable").on("click", ".ModalDeleteNeonatal", function() {
		var data = $(this).data();
		$('#DeleteNeonatal').modal({
			backdrop: 'static'
		}).draggable();
