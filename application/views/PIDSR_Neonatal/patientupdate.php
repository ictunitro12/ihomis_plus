<div class="card card-accent-success with-border"> 
		...
		<form name="frmNeonatal" enctype="multipart/form-data" id="frmNeonatal">	
		<?php echo ViewNeonatalForm();?>
			</form>	
</div>
<script type="text/javascript">
	...
	{	
		...
		initNeonatalEdit(enccode,hpercode);
...
<script src="<?php echo base_url()?>assets/scripts/pidsr_neonatal/pidsr_neonatal.js"></script>
<script src="<?php echo base_url()?>assets/scripts/pidsr_neonatal/neonatal_validation.js"></script>
