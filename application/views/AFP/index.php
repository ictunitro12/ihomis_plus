...
table#AFPTable.dataTable tbody tr:hover {
...
<div class="card card-accent-success">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="btn-group pull-right" role="group" aria-label="">
                    <a href="<?php echo site_url('AFP/PatientForm'); ?>" data-toggle="tooltip" title="Add Patient" class="btn btn-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i></a>
    ...
    <div class="card-body table-responsive">
        <table id="AFPTable" class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
...
<form id="frmAFPPDF" name="frmAFPPDF" method="post">
    <div class="modal" id="ModalAFP" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
            <div class="modal-content card-accent-success">
                <div class="modal-header">
                    <input type="hidden" name="code" id="code">
                    <h4 class="modal-title text-success"><i class="fa fa-file-pdf-o"></i> Acute Flaccid Paralysis</h4>
                    <button class="btn btn-danger btn-square float-right" data-dismiss="modal" data-style="zoom-in"><i class="fa fa-close"></i></button>
                </div>
                <div class="modal-body" id="AFPPDF"></div>
...
<script src="<?php echo base_url() ?>assets/scripts/afp/delete.js"></script>