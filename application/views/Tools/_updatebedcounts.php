...
<div class="card card-accent-success">
	...
	<div class="card-body table-responsive">
		<table id="audit_tbl" style="cursor:pointer" class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
							<thead>
								<tr>
									<th width="20px">ID</th>
									<th width="20px">Event</th>
									<th width="20px">Old Values</th>
									<th width="20px"> New values</th>
									<th width="20px">Name</th>
									<th width="20px">Address</th>
									<th width="20px">UserAgent</th>
