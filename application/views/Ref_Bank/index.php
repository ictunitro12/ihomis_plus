  ...
  background-color: #80DB88;
	...
	<div class="card card-accent-success">
			...
			<div class="row">
				...
				<div class="col-md-6 col-md-auto">
					<div class="btn-group pull-right" role="group" aria-label="">
						<button onclick="AddBank()" class="btn btn-outline-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-plus"> </i> Add Bank
						</button>
					</div>
				</div>	
			</div>	
		...
		<div class="card-body table-responsive">
			<table id="BankTable"  class="table table-sm table-striped  table-bordered table-condensedtable-hover" width="100%">
				<thead>
					<tr class="">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">	
							...
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="name" name="name" placeholder ="Bank Name" maxlength="50">
							</div>
							<div class="col-md-3 col-form-label text-default mb-1">Abbreviation:</div>
							<div class="col-md-9">
								<input type="text" class="form-control form-control-mb" autocomplete="off"   id="abbrv" name="abbrv" placeholder ="Abbreviation" maxlength="5">
							</div>
