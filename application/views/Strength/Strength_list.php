	...
	<div class="card-header">
		...
		<div class="col-md-6 col-md-auto">
			<div class="btn-group pull-right" role="group" aria-label="">
				<a class="btn btn-success" href="<?php echo site_url('Strength/Create');?>"><i class="fa fa-plus"></i></a>
			</div>
		</div>	
		</div>
	</div>
...
<table id="Strength" class="table table-sm table-hover  table-bordered table-condensed table-striped">
...
<script type="text/javascript">
	...
	function StrengthList()
	{
		var data = new Object();
		data.id = "Strength";
		data.link = "<?php echo site_url('Strength/Strength_list');?>";
		data.type = "POST";
		data.coldef =[
		{	
			targets: [2],
