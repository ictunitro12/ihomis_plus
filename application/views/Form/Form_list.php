	...
	<div class="card-header">
		...
		<div class="col-md-6 col-md-auto">
			<div class="btn-group pull-right" role="group" aria-label="">
				<a class="btn btn-success" href="<?php echo site_url('Form/Create');?>"><i class="fa fa-plus"></i></a>
			</div>
		</div>	
		</div>
	</div>
...
<table id="Form" class="table table-sm table-hover table-bordered table-condensed table-striped">
              <thead>
                <tr>
...
<script type="text/javascript">
   $(document).ready(function() {
	...
	function FormList()
	{
		var data = new Object();
		data.id = "Form";
		data.link = "<?php echo site_url('Form/Form_list');?>";
		data.type = "POST";
		data.coldef =[
		{	
			targets: [2],
