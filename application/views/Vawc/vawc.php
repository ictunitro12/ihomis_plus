...
table#VawcTable.dataTable tbody tr:hover {
  background-color: #80DB88;
	...
	<div class="card-header">
		...
		<a href="<?php echo site_url('Vawc/PatientForm');?>" data-toggle="tooltip" title="Register Patient" class="btn btn-outline-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i> &nbsp; Patient Register
	...
	<div class="card-body table-responsive">
		<table id="VawcTable" class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
			<thead>
				<tr>
					<th>enccode</th>
					<th>hpercode</th>
...
<form name="frmDeleteVawc" id="frmDeleteVawc">
	...
	<form name ="frmVawcPDF" id="frmVawcPDF" method="post">
	<div class="modal" id="ModalVawc" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
	<div class="modal-content card-accent-success">
	<div class="modal-header">
		<input name="code" id ="code" type="hidden">
	<h2 class="modal-title text-success"><i class="fa fa-heartbeat"></i> Violence Against Women and Children Registry Form</h2>
	</div>
	<div class="modal-body border-success" id="VawcPDF">
	
		<!--embed src="" frameborder="2" width="100%" height="800px" id="VawcPDF" -->
	...
	<input name="enccode" id ="enccode" type="hidden">
 	<script src="<?php echo base_url()?>assets/scripts/vawc/delete.js"></script> 
