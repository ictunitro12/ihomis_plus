	...
	<div class="card-body">
		<div class="table-responsive">
			<table id="PersonnelTable" class="table table-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr>
						<th class="align-middle all">Employee ID</th>
						<th class="align-middle all">Employee Name</th>
						<th class="align-middle all">Department</th>
						<th class="align-middle all">Position / Designation</th>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<textarea class="form-control form-control-mb mb-1" id="address" name="address" placeholder="Complete address" maxlength="155"></textarea>
								</div>
								<div class="col-md-4 col-form-label text-default mb-1">
									Contact number:
								</div>
		...
		<div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
			<div class="modal-content">
				<div class="modal-header bg-danger">
					<span class="text-white" id="id" name="id"></span>
