...
<title>TypeOfProfService</title>
</head>
<body>
<a class="btn btn-primary" href="<?php echo site_url('TypeOfProfService/Create');?>">Add</a>

<table id="TypeOfProfService" class="table table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
...
<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#TypeOfProfService").dataTable({
                    initComplete: function() {
                        var api = this.api();
                        $('#TypeOfProfService input')
                                .off('.DT')
					...
					paging: true,
					autoWidth: true,
                    ajax: {"url": "<?php echo base_url();?>index.php/TypeOfProfService/TypeOfProfService_list", "type": "POST"},
                 	columnDefs: 
					[
				    {
					targets : [5],
