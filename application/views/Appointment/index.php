<div class="w-auto card card-accent-success">
	...
	<div class="card-body table-responsive">
		<?php $this->load->view('Appointment/_appointmentsTable.php'); ?>
	</div>
</div>

<?php $this->load->view('Appointment/_appointmentConfirmationModal.php'); ?>
...
<!-- Full Calendar -->
<link rel="stylesheet" href="<?php echo base_url() ?>assets/vendors/fullcalendar/5.11.0/main.min.css">
<script src="<?php echo base_url() ?>assets/vendors/fullcalendar/5.11.0/main.min.js"></script>
