<div class="tab-pane fade" id="by_Days_of_Admission" role="tabpanel" aria-labelledby="bydaysadm-tab">
	<div class="row">
		...
		<div class="col-md-2">
			<input type="text" class="form-control form-control-mg" style="text-align:center" readonly id="btn_from_byDA">
		</div>
		<label class="col-form-label text-default">To :</label>
		<div class="col-md-2">
			<input type="text" class="form-control form-control-mg" style="text-align:center" readonly id="btn_to_byDA">
		</div>
		<div class="col-md">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var from_bDA = new Date($.session.get('from')).toLocaleDateString('en-us', {
			month: "long",
			day: "numeric",
			year: "numeric"
		});
		var to_bDA = new Date($.session.get('to')).toLocaleDateString('en-us', {
			month: "long",
			day: "numeric",
			year: "numeric"
		});
		$("#btn_from_byDA").val(from_bDA);
		$("#btn_to_byDA").val(to_bDA);
	});
...
<script src="<?php echo base_url() ?>assets/scripts/repadmaggre/aggrebyadmday.js"></script>