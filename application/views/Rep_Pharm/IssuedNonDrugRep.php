<div class="card card-accent-success">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="h4 text text-success" align = "center">
				<tr>
					<td>Summary of Issued Non-Drugs</td>
				</tr>
			</div>
	...
	<table id="Pharm_nondrugs_table" class="table table-sm table-striped table-bordered table-condensed table-hover">
...
<input type = "hidden" name = "todate"  id="todate"/>
	...
	function Pharm_nondrugs(data)
	 {
		var table =$("#Pharm_nondrugs_table").dataTable({
		 data:data,
		 destroy: true,
	...
	$.ajax({
		url:"<?php echo site_url('Rep_Pharmacy/SummaryNonDrug'); ?>",
		type:"POST",
		data:formData,
		dataType: "JSON",
		processData:false,
	...
	$('#btnCSS').on('click', function (data){
		$('#ModalCSS').modal('show');
		var src = baseURL+'Rep_Pharmacy/IssuedNonDrug/'+ $("#fromdate").val() + "/" + $("#todate").val();
