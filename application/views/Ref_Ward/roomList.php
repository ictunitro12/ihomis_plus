			...
			<table id="RoomTable" class="table table-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr class="align-middle text-center">
						<th class="align-middle text-center">brintkey</th>
						<th class="align-middle text-center">wardcode</th>
						<th class="align-middle text-center">Ward name</th>
						<th class="align-middle text-center">Room code</th>
						<th class="align-middle text-center">Room name</th>
						<th class="align-middle text-center">Room floor</th>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-3 col-form-label text-default mb-1">Room code:</div>
						<div class="col-md-9">
