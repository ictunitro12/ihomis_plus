<div class="row">
	<div class="col-md-12">
		...
		<form id="frmMedicalCertOPDPDF" name="frmMedicalCertOPDPDF" method="post">
			<div class="card card-accent-success">
				<div class="card-header">
					<div class="row">
						<div class="col-md-6 col-md-auto">
							<div class="h3 text text-success">
								<h4 class="modal-title text-success"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;Medical Certificate - OPD</h4>
							</div>
						</div>
						<div class="col-md-6 col-md-auto">
				...
				<div class="card-body" id="MedicalCertOPD"></div>
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="col-md-12" align="center">
							<a href="javascript:void(0)"  id="certopdlink" data-toggle="tooltip" data-placement="top"  class="btn btn-success btn-md  btn-ladda" data-style="zoom-in">OK</a>
...
<input name="module" id="module" type="hidden" value="medicalcertopd">
...
<script src="<?php echo base_url()?>assets/scripts/medicalcertopd/medicalcertopd.js"></script>
