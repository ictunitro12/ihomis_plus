<style>
	...
	table#BlindnessTable.dataTable tbody tr:hover {
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-auto">
				<div class="btn-group pull-right" role="group" aria-label="">
					<a href="<?php echo site_url('Blindness/PatientForm');?>" data-toggle="tooltip" title="Register Patient" class="btn btn-outline-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i> &nbsp; Patient Register</a>
				</div>
			</div>	
		</div>
	</div>
	<div class="card-body table-responsive">
		<table id="BlindnessTable" class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
			<thead>
				<tr>
					<th>enccode</th>
					<th>PATIENT ID</th>
...
<form name="frmDeleteBlindness" id="frmDeleteBlindness">
	<input type="hidden" name="formIdentification" id="formIdentification">
	<input type="hidden" name="deletecode" id="deletecode">


	<div class="modal fade" id="DeleteBlindness" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
			<div class="modal-content">
...
<form name ="frmBlindnessPDF" id="frmBlindnessPDF" method="post">
	<div class="modal" id="ModalBlindness" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
			<div class="modal-content card-accent-success">
				<div class="modal-header">
					<input name="code" id ="code" type="hidden">
					<h2 class="modal-title text-success"><i class="fa fa-heartbeat"></i> Prevention of Blindness Registry Form</h2>
				</div>
				<div class="modal-body border-success" id="BlindnessPDF">
	...
	<script src="<?php echo base_url()?>assets/scripts/blindness/delet.js"></script> 
