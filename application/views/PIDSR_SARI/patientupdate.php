<div class="card card-accent-success with-border"> 
		...
		<form name="frmSARI" enctype="multipart/form-data" id="frmSARI">	
		<?php echo ViewSARIForm();?>
			</form>	
</div>
...
<script src="<?php echo base_url()?>assets/scripts/pidsr_sari/pidsr_sari.js"></script>
<script src="<?php echo base_url()?>assets/scripts/pidsr_sari/sari_validation.js"></script>
