<form id="frmDeleteModule" name="frmDeleteModule" method="post">
	<div class="modal" id="deleteModuleModal" name="deleteModuleModal" tabindex="-1" role="form">
		...
		<h2 class="modal-title text-danger" <i class="fa fa-trash"></i> Delete Record ?</h2>
			...
			<input type="hidden" name="moduleIDDel" id="moduleIDDel">
			<input type="hidden" name="moduleformIdenDelete" id="moduleformIdenDelete" value="delete">
		</div>
