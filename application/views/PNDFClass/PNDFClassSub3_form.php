...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">PNDF Class Sub Group 3<?php echo $button ?></h2>
    <form action="<?php echo $action; ?>" method="post">
	    <div class="form-group">
            <label for="varchar">Sub Group 2:</label>
            <input type="text" class="form-control" name="dmsub2" id="dmsub2" placeholder="PNDFClass Code" value="<?php echo $dmsub2; ?>" /><?php echo form_error('dmsub2') ?>
        </div>
		
		<div class="form-group">
		    <label for="varchar">Sub Group 3:</label>
            <input type="text" class="form-control" name="dmsub3" id="dmsub3" placeholder="Sub Group 3" value="<?php echo $dmsub3; ?>" /><?php echo form_error('dmsub3') ?>
        </div>
	    

		<div class="form-group">
		    <label for="varchar">Description:</label>
            <input type="text" class="form-control" name="dms3desc" id="dms3desc" placeholder="Description" value="<?php echo $dms3desc; ?>" /><?php echo form_error('dms3desc') ?>
        </div>
