...
<div class="card card-accent-success">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-auto">
				<div class="btn-group pull-right" role="group" aria-label="">
					<button onclick="AddStrength()" class="btn btn-outline-success btn-md btn-ladda" data-style="zoom-in"><i class="fa fa-plus"></i>&nbsp;Add Strength</button>
				</div>
			</div>
		</div>
	</div>
	<div class="card-body">
		<div class="table-responsive">
			<table id="StrengthTable" class="table table-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr>
