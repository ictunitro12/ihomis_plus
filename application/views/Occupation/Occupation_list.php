...
<body>
<a class="btn btn-primary" href="<?php echo site_url('Occupation/Create');?>">Add</a>

<table id="Occupation" class="table table-hover  table-bordered table-condensed table-striped">
              <thead>
                <tr>
                <th width="80px">SMajor Code</th>
				<th>SMajor Description</th>
                <th>Major Code</th>
...
<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#Occupation").dataTable({
					...
					paging: true,
					autoWidth: true,
                    ajax: {"url": "<?php echo base_url();?>index.php/Occupation/Occupation_list", "type": "POST"},
                 	columnDefs: 
					[
				    {
					targets : [4],
