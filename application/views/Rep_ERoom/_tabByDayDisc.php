		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="h5 text-success" align="center">
					From :&nbsp;
					<label id="fromDayDis"></label>&nbsp;&nbsp;&nbsp;To :&nbsp;
					<label id="toDayDis"></label>
					<button type="button" id="btnPDFby_DateDisc" title="Print PDF" class="btn btn-success btn-md mb-1 pull-right" data-style="zoom-in"><i class="fa fa-file-pdf-o"></i>
					</button>
				</div>
			</div>
			<!-- <div class="col-md-12">
	...
	<script type="text/javascript">
		...
		function drDayDis() {
			...
			document.getElementById('toDayDis').innerHTML = to_bS;
			document.getElementById('fromDayDis').innerHTML = from_bS;
		}
		...
		$('#btnPDFby_DateDisc').click('click', function() {
			...
			var x = document.getElementById("printpdfDateDisc").src = baseURL + "Rep_ER/By_DischargeDatePDF/" + from + "/" + to;
			console.log(x);
		});
	</script>
	<script src="<?php echo base_url() ?>assets/scripts/reperaggregates/aggrebydisdate.js"></script>