	...
	<div class="card-body table-responsive">
		...
		<table id="ERTable" class="table table-sm table-striped table-bordered table-condensed table-hover">
			<thead class="thead-dark">
				<tr>
					<th>CASENUMBER</th>
					<th>DATE AND TIME OF ADMISSION<br>(<small>mm/dd/yyyy hh:mm: am/pm</small>)</th>
					<th>NAME OF PATIENT<br>(<small>Firstname,Middlename,Lastname Suffix</small>)</th>
					<th>DATE OF BIRTH</th>
					<th>SEX<br>(<small>Male,Female</small>)</th>
					<th>ADDRESS<br>(<small>Street, Barangay, City, Province</small>)</th>
					<th>MEMBERSHIP</th>
					<th>DIAGNOSIS</th>
...
<script type="text/javascript">
	...
	$('#dateRange').submit('click', function() {
		if ($("#from").val() == "" || $("#to").val() == "") {
			...
			$.ajax({
				url: "<?php echo site_url('Rep_ER/ERLogbook'); ?>",
				type: "POST",
	...
	$('#btnCSS').on('click', function(data) {
		...
		var src = baseURL + 'Rep_ER/ERBook/' + from + "/" + to;
