...
<input name="module" id="module" type="hidden" value="chikungunya">
...
<div class="card card-accent-success">
	<div class="card-header">
		<div class="row">
			<div class="col-md">
				<h4 class="card-title text-success"><i class="fa fa-user-circle-o"></i>&nbsp; Chikungunya Viral Disease (ICD 10 Code: A92.0)</h4>
			</div>
	...
	<div class="card-body">
		...
		<div class="form-row">
			<div class="col-md-3">
				<div class="form-row">
					<label class="col-md-5 col-form-label text-default mb-1">Patient Admitted :</label>
					<div class="col-md-7">
				...
				<div class="form-row">
					<label class="col-md-5 col-form-label text-default mb-1">Consulted :</label>
					<div class="col-md-7">
				...
				<div class="form-row">
					<label class="col-md-5 text-default mb-1">Date Admitted/ Seen/Consulted:</label>
					<div class="col-md-7">
						<input type="datetime-local" class="form-control form-control-md mb-1" id="date_admitted" name="date_admitted">
					</div>
				</div>
				<div class="form-row">
					<label class="col-md-5 col-form-label text-default mb-1"><i class="fa fa-asterisk text-danger"></i> Date Onset of Illness:</label>
					<div class="col-md-7">
			...
			<div class="col-md-9">
				...
				<div class="form-row">
					<label class="col-md-1 col-form-label text-default mb-1">Fever :</label>
					<div class="col-md-1">
						<select name="fever" id="fever" class="form-control form-control-md">
							<option value="">Select</option>
							<option value="Y">Yes</option>
							<option value="N">No</option>
						</select>
					</div>
					<label class="col-md-1 col-form-label text-default mb-1">Arthralgia :</label>
					<div class="col-md-1">
						<select name="arthralgia" id="arthralgia" class="form-control form-control-md">
							<option value="">Select</option>
							<option value="Y">Yes</option>
							<option value="N">No</option>
						</select>
					</div>
					<label class="col-md-2 col-form-label text-default mb-1">Date Onset of Arthralgia :</label>
					<input type="datetime-local" name="date_arthralgia" id="date_arthralgia" class="col-md-2 form-control form-control-md mb-1" disabled/>
				...
				<div class="form-row">
					...
					<label class="col-md-2 col-form-label text-default mb-1">Place of Consultation:</label>
					<div class="col-md-4">
						<input type="text" class="form-control form-control-md mb-1" id="placefirstconsult" name="placefirstconsult">
					</div>
				</div>
				<div class="form-row">
					<label class="col-md-5 col-form-label text-default mb-1">Is there history of travel within 15 days to known ongoing epidemic ChikV Case ?:</label>
					<select class="col-md-1 form-control form-control-md mb-1" id="historytravel" name="historytravel">
						<option value="">Select</option>
						<option value="Y">Yes</option>
						<option value="N">No</option>
					</select>
					...
					<div class="col-md-4">
						<input type="text" class="form-control form-control-md mb-1" id="historytravel_specify" name="historytravel_specify" disabled/>
					</div>
				</div>
			</div>
			<table class="table table-sm table-bordered table-condensed table-responsived" width="100%">
				<thead class="bg-success text-white">
					<tr align="center">
						<th colspan="2">Serology IgM</th>
						<th colspan="2">Serology IgG ELISA </th>
						<th colspan="2">RT-PCR</th>
						<th colspan="2">Viral Isolation</th>
					</tr>
					<tr align="center">
						<th>Result</th>
						<th>Date Done </th>
				...
				<tbody>
					<tr>
						<td>
							<select class="form-control form-control-md" id="seroigmresult" name="seroigmresult">
								<option value="">Select</option>
						...
						<td><input type="date" class="form-control form-control-md" id="serodatedone" name="serodatedone"></td>
						<td>
							<select class="form-control form-control-md" id="seroiggresult" name="seroiggresult">
								<option value="">Select</option>
								<option value="P">Positive</option>
								<option value="N">Negative</option>
								<option value="E">Equivocal</option>
						...
						<td><input type="date" class="form-control form-control-md" id="seroiggdatedone" name="seroiggdatedone"></td>
						<td>
							<select class="form-control form-control-md" id="rtpcrresult" name="rtpcrresult">
								<option value="">Select</option>
								<option value="P">Positive</option>
								<option value="N">Negative</option>
								<option value="E">Equivocal</option>
						...
						<td><input type="date" class="form-control form-control-md" id="rtpcrdatedone" name="rtpcrdatedone"></td>
						<td>
							<select class="form-control form-control-md" id="viralisoresult" name="viralisoresult">
								<option value="">Select</option>
								<option value="P">Positive</option>
								<option value="N">Negative</option>
								<option value="E">Equivocal</option>
						...
						<td><input type="date" class="form-control form-control-md" id="viralisodatedone" name="viralisodatedone"></td>
					</tr>
				</tbody>
			</table>
