<style>
	table#ChikungunyaTable.dataTable tbody tr:hover {
...
<div class="card card-accent-success">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-auto">
				<div class="btn-group pull-right" role="group" aria-label="">
					<a href="<?php echo site_url('PIDSR_Chikungunya/PatientForm'); ?>" data-toggle="tooltip" title="Register Patient" class="btn btn-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i>
					</a>
	...
	<div class="card-body">
		<div class="table-responsive">
			<table id="ChikungunyaTable" class="table table-sm table-striped table-borderless table-condensed table-hover" width="100%">
...
<form name="frmDeleteChikungunya" id="frmDeleteChikungunya">
	<input type="hidden" name="formIdentification" id="formIdentification">
	<input type="hidden" name="deletecode" id="deletecode">
	<div class="modal fade" id="DeleteChikungunya" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
			<div class="modal-content">
...
<form method="post">
	<div class="modal" id="ModalChikungunya" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-dialog-centered modal-xl" role="dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<embed id="printchikungunyapdfmodal" type="application/pdf" frameborder="2" width="100%" height="800px">
				</div>
...
<script src="<?php echo base_url() ?>assets/scripts/pidsr_chikungunya/delete.js"></script>
...
<script type="text/javascript">
	...
	function pdfprint() {
		...
		$('#printpdf').click('click', function() {
			$('#ModalChikungunya').modal({
				backdrop: 'static'
			}).draggable();
			var x = document.getElementById("printchikungunyapdfmodal");
			x.src = baseURL + "PIDSR_Chikungunya/Chikungunya_pdf";
		});
	}

	function PatientLogList() {
		var data = new Object();
		data.id = "ChikungunyaTable";
		data.link = baseURL + "PIDSR_Chikungunya/chikungunyaList";
		data.type = "POST";
		data.coldef = [{
			targets: [0, 1],
			visible: false,
	...
	$("#ChikungunyaTable").on("click", ".ModalDeleteChikungunya", function() {
		var data = $(this).data();
		$('#DeleteChikungunya').modal({
			backdrop: 'static'
		}).draggable();
	...
	/* $("#ChikungunyaTable").on("click", ".ModalChikungunya", function() {
		var data = $(this).data();
		$('#ModalChikungunya').modal({
			backdrop: 'static'
		}).draggable();
