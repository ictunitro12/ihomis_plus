			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="form-row">
						...
						<div class="col-md-8">
							<input type="datetime-local" class="form-control form-control-mb" autocomplete="off" id="diagDateLog" name="diagDateLog" placeholder="">
						</div>
						...
						<div class="col-md-8">
							<select class="form-control form-control-mb" autocomplete="off" id="diagType" name="diagType">
						...
						<div class="col-md-8">
							<select class="form-control form-control-mb" autocomplete="off" id="diagPrime" name="diagPrime">
								<option value="">Select</option>
						...
						<div class="col-md-8">
							<select class="form-control form-control-mb" autocomplete="off" id="diagDoc_doc" name="diagDoc_doc">
								<option value="">Select</option>
							</select>
						</div>
					</div>
