			...
			<div class="row">
				<div class="col-md-6 col-md-auto">
					<div class="h3 text text-success">
						<h4 class="modal-title text-success"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;Medico Legal Discharged</h4>
					</div>
				</div>
				<div class="col-md-6 col-md-auto">
...
function PatSearchList(data)
	 {
		...
		$('#TblPatSearchList').on('click', 'tr', function () {
			...
			var x = document.getElementById("pdf_patrec").src = baseURL+"Rep_MedicalRecord_pdf/MedLegalCertDisc_pdf/"+hpercode;
		});
	}
...
$('#frmPatSearch').submit('click',function(){
	$.ajax({
		url:baseURL+"Rep_MedicalRecord/PatientSearchMidLegalDisc",
		type:"POST",
