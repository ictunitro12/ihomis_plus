<form id="addIncomingReferralForm">
    ...
    <div class="card card-accent-success with-border">
        <div class="card-header">
            <div class="row">
                <div class="col-md">
                    <h4 class="card-title text-success"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp; Add
                        Incoming Referral</h4>
                </div>
                <div class="col-md">
                    <div class="float-md-right">
                        <button class="btn btn-danger" id="cancelAddReferralFrom"><i class="fa fa-times" aria-hidden="true"></i> Cancel</button>
                        <button class="btn btn-success" type="submit" id="saveReferralFrom"><i
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="text"
                                    ...
                                    id="LogID" name="LogID" value="<?php echo $logid;?>">
...
<script src="<?php echo base_url()?>assets/scripts/referral/addreferralfrom.js"></script>