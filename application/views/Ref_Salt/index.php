...
<div class="card card-accent-success">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-auto">
				<div class="btn-group pull-right"  role="group" aria-label="">
					<button onclick="AddSalt()" class="btn btn-outline-success btn-md btn-ladda" data-style="zoom-in" data-original-title="Add Salt" data-toggle="tooltip"><i class="fa fa-plus"> </i> Add Salt</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="card-body table-responsive">
		<table id="SaltTable" class="table table-sm table-striped  table-bordered table-condensedtable-hover" width="100%">
			<thead>
