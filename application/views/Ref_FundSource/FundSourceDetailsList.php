  ...
  background-color: #80DB88;
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-4 col-form-label text-default mb-1">Fund Source:</div>
							<div class="col-md-8">
								<input type="text" class="form-control form-control-mb" autocomplete="off" readonly="" id="funddesc" name="funddesc" placeholder="Fund Source Name">
							</div>
							<div class="col-md-4 col-form-label text-default mb-1">Amount:</div>
							<div class="col-md-8">
								<input type="text" class="form-control form-control-mb" autocomplete="off" id="fundamt" name="fundamt" placeholder="Amount">
							</div>
	...
	<script type="text/javascript">
		...
		$("#FundsourceDetailsTable").on("click", ".ModalDeleteFundsourcedetails", function() {
			var data = $(this).data();
			$('#DeleteFundsourcedetails').modal({ backdrop: 'static' }).draggable();
		...
		$("#FundsourceDetailsTable").on("click", ".ModalEditFundsourcedetails", function() {
			var data = $(this).data();
			$('#ModalAddFundsourcedetails').modal({ backdrop: 'static' }).draggable();
			$("#formIden").val('update');
			var fundcode = atob('<?php echo $this->uri->segment(3); ?>');
			var funddesc = atob('<?php echo $this->uri->segment(4); ?>');
