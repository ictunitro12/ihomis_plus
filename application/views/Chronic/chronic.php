<style>
	...
	table#ChronicTable.dataTable tbody tr:hover {
...
<div class="card card-accent-success">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-auto">
				<div class="btn-group pull-right" role="group" aria-label="">
					<a href="<?php echo site_url('Chronic/PatientForm');?>" data-toggle="tooltip" title="Patient Register" class="btn btn-outline-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i> &nbsp; Patient Register						
					</a>
				</div>
			</div>	
		</div>
	...
	<div class="card-body table-responsive">
		<table id="ChronicTable"  class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
			<thead>
				<tr>
					<th>enccode</th>
					<th>PATIENT ID</th>
			...
			<div class="modal-body">
				...
				<div class="box-body box-profile">
					...
					<ul class="list-group">
						...
						<li class="list-group-item">
							<b class="text text-success"><i class="fa fa-calendar"></i>&nbsp Type of COPD:</b>
							<a class="pull-right text text-success" id="copd_type">N/A</a>
						</li>
						<li class="list-group-item">
...
<form name ="frmChronicPDF" id="frmChronicPDF" method="post">
	<div class="modal" id="ModalChronic" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
			<div class="modal-content card-accent-success">
				<div class="modal-header">
					...
					<h2 class="modal-title text-success"><i class="fa fa-heartbeat"></i> Chronic Obstructive Pulmonary Disease Registry Form</h2>
				</div>
				<div class="modal-body border-success" id="chronicPDF">
				</div>
...
<script src="<?php echo base_url()?>assets/scripts/chronic/delete.js"></script>
<script src="<?php echo base_url()?>assets/scripts/chronic/copd.js"></script>
