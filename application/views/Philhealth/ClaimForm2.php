        ...
        <div class="card card-accent-success">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col">
                        <a href="javascript:void(0)" id="patientsearch" data-toggle="tooltip" title="Search Patient"
                            class="btn btn-success btn-md btn-ladda ladda-button pull-right" data-style="zoom-in"><span
                                class="ladda-label"><i class="fa fa-search"></i></span><span
                                class="ladda-spinner"></span></a>
                        <a href="<?php
                                    $enccode = urlencode(urlencode($enccode));
                                    echo base_url() . 'Philhealth/generateClaimForm2PDF/' . $enccode;
                                    ?>" target="_blank" id="printclaimform2" data-toggle="tooltip"
                            title="Print Claim Form 2" class="btn btn-success btn-md btn-ladda ladda-button pull-right"
                            data-style="zoom-in"><span class="ladda-label"><i class="fa fa-print"
                                    aria-hidden="true"></i></span><span class="ladda-spinner"></span></a>
                    </div>
                </div>
                <hr>
                <div class="row">
            ...
            <div class="card-body table-responsive">
                <ul class="nav nav-tabs nav-justified" id="myTab1" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link text text-success active" id="confineinfo-tab" data-toggle="tab"
                            href="#confineinfo" role="tab" aria-controls="confineinfo" aria-expanded="true"><i
                                class="fa fa-hospital-o fa-2x"></i>&nbsp CONFINEMENT INFORMATION</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text text-success" id="diagnosis-tab" data-toggle="tab" href="#diagnosis"
                            role="tab" aria-controls="diagnosis" aria-expanded="true"><i
                                class="fa fa-user-md fa-2x"></i>&nbsp DIAGNOSES/PROCEDURES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text text-success" id="specialcon-tab" data-toggle="tab" href="#specialcon"
                            role="tab" aria-controls="specialcon"><i class="fa fa-plus-square fa-2x"></i>&nbsp SPECIAL
                            CONSIDERATION</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text text-success" id="profserv-tab" data-toggle="tab" href="#profserv"
                            role="tab" aria-controls="profserv"><i class="fa fa-credit-card fa-2x"></i> PROFESSIONAL
                            FEES/CHARGES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text text-success" id="benefits-tab" data-toggle="tab" href="#benefits"
                            role="tab" aria-controls="benefits"><i class="fa fa-bar-chart  fa-2x"></i> CONSUMPTION OF
                            BENEFITS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text text-success" id="consent-tab" data-toggle="tab" href="#consent"
                            role="tab" aria-controls="consent"><i class="fa fa-file-o fa-2x"></i> CONSENT</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="confineinfo" role="tabpanel"
                        aria-labelledby="confineinfo-tab">
                        <br>
                        <form action="">
                            <!--div class="row">
                                <div class="col">
                    ...
                    <div class="tab-pane fade" id="specialcon" role="tabpanel" aria-labelledby="specialcon-tab">
                        <form id="specialForm">
                            <input type="hidden" id="specialFormEnccode" name="specialFormEnccode"
                                value="<?php echo $enccode; ?>">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            <label for="pCataractPreAuth">Cataract Pre-Authorization Application
                                                Number:</label>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <input class="form-control form-control-sm" type="text"
                                                    id="pCataractPreAuth" name="pCataractPreAuth">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input class="form-control form-control-sm" type="text"
                                                    id="pLeftEyeIOLStickerNumber" name="pLeftEyeIOLStickerNumber">
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                <input class="form-control form-control-sm" type="date"
                                                    id="pLeftEyeIOLExpiryDate" name="pLeftEyeIOLExpiryDate">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                <input class="form-control form-control-sm" type="text"
                                                    id="pRightEyeIOLStickerNumber" name="pRightEyeIOLStickerNumber">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                <input class="form-control form-control-sm" type="date"
                                                    id="pRightEyeIOLExpiryDate" name="pRightEyeIOLExpiryDate">
                                                <!--span id="pLeftEyeIOLExpiryDate"></span-->
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-sm" type="text"
                                                    id="pzbenefitcode" name="pzbenefitcode">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                        ...
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm"
                                                    aria-describedby="pcheckupdate1_label" id="pcheckupdate1"
                                                    name="pcheckupdate1">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm"
                                                    aria-describedby="pcheckupdate1_label" id="pcheckupdate2"
                                                    name="pcheckupdate2">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm"
                                                    aria-describedby="pcheckupdate1_label" id="pcheckupdate3"
                                                    name="pcheckupdate3">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm"
                                                    aria-describedby="pcheckupdate1_label" id="pcheckupdate4"
                                                    name="pcheckupdate4">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <input class="form-control form-control-sm" type="date" id="plmp"
                                                    name="plmp">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="pntpcardNo_label">NTP Card
                                                        No.:</span>
                                                </div>
                                                <input type="text" class="form-control form-control-sm" id="pntpcardNo"
                                                    name="pntpcardNo" aria-describedby="pntpcardNo_label">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="I" id="intensive"
                                                    name="intensive">
                                ...
                                <div class="col">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span>(write the dates [mm-dd-yyyy] when the following doses of vaccine were
                                                given)</span>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm" id="pday0arv"
                                                    name="pday0arv" aria-describedby="pday0arv_label">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm" id="pday3arv"
                                                    name="pday3arv" aria-describedby="pday3arv_label">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm" id="pday7arv"
                                                    name="pday7arv" aria-describedby="pday7arv_label">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm" id="prig"
                                                    name="prig" aria-describedby="prig_label">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="input-group input-group-sm">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="pabpothers_label">Other
                                                        Date</span>
                                                </div>
                                                <input type="date" class="form-control form-control-sm" id="pabpothers"
                                                    name="pabpothers" aria-describedby="pabpothers_label">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group input-group-sm">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="pabpspecify_label">Others
                                                        (Specify)</span>
                                                </div>
                                                <input type="text" class="form-control form-control-sm" id="pabpspecify"
                                                    name="pabpspecify" aria-describedby="pabpspecify_label">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-check" name="pessentialnewborncare-check">
                                                <input class="form-check-input" type="checkbox" value="Y"
                                                    id="pessentialnewborncare" name="pessentialnewborncare">
                                        ...
                                        <div class="col">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Y"
                                                    id="pnewbornhearingscreeningtest"
                                        ...
                                        <div class="col">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Y"
                                                    id="pnrebornscreeningtest" name="pnrebornscreeningtest">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="pfiltercardno" name="pfiltercardno">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Y"
                                                            id="pcordclamping" name="pcordclamping">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Y"
                                                            id="pskintoskin" name="pskintoskin">
                                                ...
                                                <div class="col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Y"
                                                            id="pprophylaxis" name="pprophylaxis">
                                                ...
                                                <div class="col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Y"
                                                            id="phepatitisb" name="phepatitisb">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="Y"
                                                    id="pnonseparation" name="pnonseparation">
                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="plaboratorynumber" name="plaboratorynumber">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="profserv" role="tabpanel" aria-labelledby="profserv-tab">
                        ...
                        <div class="table-responsive" style="overflow-x: visible; overflow-y: visible;">
                            <table id="ProfessionalTable"
                                class="table table-sm table-striped table-borderless table-condensed table-hover"
                                width="100%">
                                <thead class="thead-dark">
                                    <tr>
                                        <th></th>
                    ...
                    <div class="tab-pane fade" id="benefits" role="tabpanel" aria-labelledby="benefits-tab">
                        <br>
                        <form id="frmBenefits">
                            <input type="hidden" id="benefitsEnccode" name="benefitsEnccode"
                                value="<?php echo $enccode; ?>">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <select name="firstcase" id="firstcase"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="number" readonly name="amt1" id="amt1"
                                                    class="form-control form-control-sm">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="number" name="amthosp1" id="amthosp1" min="0"
                                                    class="form-control form-control-sm">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="number" name="amtpf1" id="amtpf1" min="0"
                                                    class="form-control form-control-sm">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <select name="secondcase" id="secondcase"
                                                    class="form-control form-control-sm">
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="number" readonly name="amt2" id="amt2"
                                                    class="form-control form-control-sm">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="number" name="amthosp2" id="amthosp2" min="0"
                                                    class="form-control form-control-sm">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="number" name="amtpf2" id="amtpf2" min="0"
                                                    class="form-control form-control-sm">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="penough"
                                                            name="penough" value="Y">
                                                        <label class="form-check-label" for="penough">PhilHealth benefit
                                                            is enough to cover HCI and PF charges.<br>No purchases of
                                                            drugs/medicines, supplies, diagnostics, and co-pay for
                                                            professional fees by the member/patient.</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col mx-5">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col border text-center font-weight-bold">
                                                            <input type="hidden" id="ptotalhcifeesval"
                                                                name="ptotalhcifeesval">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col border text-center font-weight-bold">
                                                            <input type="hidden" id="ptotalproffeesval"
                                                                name="ptotalproffeesval">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col border text-center font-weight-bold">
                                                            <input type="hidden" id="pgrandtotalval"
                                                                name="pgrandtotalval">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="pexcess"
                                                            name="pexcess" value="Y">
                                                        <label class="form-check-label" for="pexcess">The benefit of the
                                                            member/patient was completely consumed prior to co-pay OR
                                                            the benefit of the member/patient is not completely consumed
                                                            BUT with purchases/expenses for drugs/medicines, supplies,
                                                            diagnostics and others.</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                        ...
                                                        <div class="col px-5">
                                                            ...
                                                            <table class="table table-bordered table-sm">
                                                                <thead>
                                                                    <tr>
                                                                        <th></th>
                                                                        <th class="text-center">Total Actual Charges*
                                                                        </th>
                                                                        <th class="text-center">Amount after Application
                                                                            of<br>Discount (i.e., personal
                                                                            discount,<br>Senior Citizen/PWD</th>
                                                                        <th class="text-center">PhilHealth Benefit</th>
                                                                        <th class="text-center">Amount after PhilHealth
                                                                            Deduction</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="hidden"
                                                                                id="ptotalactualchargeshcival"
                                                                                name="ptotalactualchargeshcival">
                                                                            <span id="ptotalactualchargeshci"></span>
                                                                        </td>
                                                                        <td>
                                                                            <input type="hidden" id="pdiscounthcival"
                                                                                name="pdiscounthcival">
                                                                            <span id="pdiscounthci"></span>
                                                                        </td>
                                                                        <td>
                                                                            <input type="hidden"
                                                                                id="philhealthbenehcival"
                                                                                name="philhealthbenehcival">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <span
                                                                                                ...
                                                                                                id="ptotalamouthci_label">Amount
                                                                                                P</span>
                                                                                        </div>
                                                                                        <input type="number" min="0"
                                                                                            ...
                                                                                            name="ptotalamouthci"
                                                                                            class="form-control form-control-sm"
                                                                                            aria-describedby="ptotalamouthci_label">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col">
                                                                                    <div class="form-group form-check">
                                                                                        <input type="checkbox"
                                                                                            ...
                                                                                            id="pmemberpatienthci"
                                                                                            name="pmemberpatienthci"
                                                                                            value="Y">
                                                                                        <label class="form-check-label"
                                                                                            for="pmemberpatienthci">Member/Patient</label>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col">
                                                                                    <div class="form-group form-check">
                                                                                        <input type="checkbox"
                                                                                            class="form-check-input"
                                                                                            id="phmohci" name="phmohci"
                                                                                            value="Y">
                                                                                        <label class="form-check-label"
                                                                                            for="phmohci">HMO</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                    <div class="form-group form-check">
                                                                                        <input type="checkbox"
                                                                                            class="form-check-input"
                                                                                            id="pothershci"
                                                                                            name="pothershci" value="Y">
                                                                                        <label class="form-check-label"
                                                                                            for="pothershci">Others
                                                                                            (i.e., PCSO, Promissory
                                                                                            note, etc.)</label>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <tr>
                                                                        <th>Total Professional Fees<br>(for
                                                                            accredited<br>and
                                                                            non-accredited<br>professionals)
                                                                        </th>
                                                                        <td>
                                                                            <input type="hidden"
                                                                                id="ptotalactualchargespfval"
                                                                                name="ptotalactualchargespfval">
                                                                            <span id="ptotalactualchargespf"></span>
                                                                        </td>
                                                                        <td>
                                                                            <input type="hidden" id="pdiscountpfval"
                                                                                name="pdiscountpfval">
                                                                            <span id="pdiscountpf"></span>
                                                                        </td>
                                                                        <td>
                                                                            <input type="hidden"
                                                                                id="philhealthbenepfval"
                                                                                name="philhealthbenepfval">
                                                                                ...
                                                                                <div class="col">
                                                                                    <div
                                                                                        ...
                                                                                        <input type="number" min="0"
                                                                                            ...
                                                                                            name="ptotalamoutpf"
                                                                                            class="form-control form-control-sm"
                                                                                            aria-describedby="ptotalamoutpf_label">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col">
                                                                                    <div class="form-group form-check">
                                                                                        <input type="checkbox"
                                                                                            class="form-check-input"
                                                                                            id="pmemberpatientpf"
                                                                                            name="pmemberpatientpf"
                                                                                            value="Y">
                                                                                        <label class="form-check-label"
                                                                                            for="pmemberpatientpf">Member/Patient</label>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col">
                                                                                    <div class="form-group form-check">
                                                                                        <input type="checkbox"
                                                                                            class="form-check-input"
                                                                                            id="phmopf" name="phmopf"
                                                                                            value="Y">
                                                                                        <label class="form-check-label"
                                                                                            for="phmopf">HMO</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                    <div class="form-group form-check">
                                                                                        <input type="checkbox"
                                                                                            class="form-check-input"
                                                                                            id="potherspf"
                                                                                            name="potherspf" value="Y">
                                                                                        <label class="form-check-label"
                                                                                            for="potherspf">Others
                                                                                            (i.e., PCSO, Promissory
                                                                                            note, etc.)</label>
                                                                                    </div>
                                                                                </div>
                                            ...
                                            <div class="px-5">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 border">
                                                        Total cost of purchase/s for drugs/medicines and/or medical
                                                        supplies bought by the patient/member within/outside the HCI
                                                        during confinement
                                                    </div>
                                                    <div class="col-6 border">
                                                        <div class="row pt-2">
                                                            <div class="col">
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="medsuppliesoutno" name="medsuppliesoutno"
                                                                        value="Y">
                                                                    <label class="form-check-label"
                                                                        for="medsuppliesoutno">None</label>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="medsuppliesoutyes" name="medsuppliesoutyes"
                                                                        value="Y">
                                                                    <label class="form-check-label"
                                                                        for="medsuppliesoutyes">Total Amount</label>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="input-group input-group-sm">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text"
                                                                            id="pdmsttotal_label">P</span>
                                                                    </div>
                                                                    <input type="number" min="0" step="0.01"
                                                                        id="pdmsttotal" name="pdmsttotal"
                                                                        class="form-control form-control-sm"
                                                                        aria-describedby="pdmsttotal_label">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 border">
                                                        Total cost of diagnostic/laboratory examinations paid for by the
                                                        patient/member done within/outside the HCI during confinement
                                                    </div>
                                                    <div class="col-6 border">
                                                        <div class="row pt-2">
                                                            <div class="col">
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="pexaminationsoutno"
                                                                        name="pexaminationsoutno" value="Y">
                                                                    <label class="form-check-label"
                                                                        for="pexaminationsoutno">None</label>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group form-check">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        id="pexaminationsoutyes"
                                                                        name="pexaminationsoutyes" value="Y">
                                                                    <label class="form-check-label"
                                                                        for="pexaminationsoutyes">Total Amount</label>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="input-group input-group-sm">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text"
                                                                            id="pexamstotal_label">P</span>
                                                                    </div>
                                                                    <input type="number" min="0" step="0.01"
                                                                        id="pexamstotal" name="pexamstotal"
                                                                        class="form-control form-contrl-sm"
                                                                        aria-describedby="pexamstotal_label">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="tab-pane fade" id="consent" role="tabpanel" aria-labelledby="consent-tab">
                        <br>
                        <form id="frmConsent">
                            <input type="hidden" id="consentEnccode" name="consentEnccode"
                                value="<?php echo $enccode; ?>">
                            <div class="row">
                                <div class="col">
                                    <button type="submit" class="btn btn-success pull-right"><i class="fa fa-floppy-o"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="consentSign" id="memberSign"
                                            value="M">
                                        <label class="form-check-label" for="memberSign">Member</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="consentSign" id="patientSign"
                                            value="P">
                                        <label class="form-check-label" for="patientSign">Patient</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="consentSign"
                                            id="representativeSign" value="R">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        <div class="col">
                                            <label for="consentname">Name of Member/Patient/Authorized
                                                Representative</label>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-sm" id="consentname"
                                                    name="consentname">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="date" class="form-control form-control-sm" id="consentdate"
                                                    name="consentdate">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        <div class="col">
                                            <label for="pRelCode">Relationship of the representative to the
                                                member/patient</label>
                                        </div>
                                        <div class="col">
                                            <select name="pRelCode" id="pRelCode" class="form-control form-control-sm"
                                                disabled>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        <div class="col">
                                            <label for="pReasonCode">Reason for signing on behalf of the
                                                member/patient</label>
                                        </div>
                                        <div class="col">
                                            <select name="pReasonCode" id="pReasonCode" disabled
                                                class="form-control form-control-sm">
                                ...
                                <div class="col">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <input type="text" disabled class="form-control form-control-sm"
                                                    id="pReasonDesc" name="pReasonDesc">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <label for="pThumbMarkedBy">If patient/representative is unable to write, thumbmark
                                        by</label>
                                </div>
                                <div class="col-3">
                                    <select name="pThumbMarkedBy" id="pThumbMarkedBy"
                                        class="form-control form-control-sm">
                            ...
                            <div class="row">
                                <div class="col">
                                    <b class="text text-success">CERTIFICATION OF CONSUMPTION OF HEALTH CARE
                                        INSTITUTION</b>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg">
                                    <div class="form-group">
                                        <label for="authsign_doc" class="col-form-label text-left">Name of Authorized
                                            HCI Representative:</label>
                                        <select class="form-multi-select" data-coreui-multiple="false" data-width="100%"
                                            name="authsign_doc" id="authsign_doc">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-sm" id="authsigndate"
                                            name="authsigndate">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title text-white"><i class="fa fa-trash-o"></i>&nbsp <span
                            id="delDiagnosis"></span></h5>
                ...
                <div class="modal-footer bg-secondary">
                    <button type="submit" class="btn btn-danger btn-square btn-ladda" data-style="zoom-in"><i
        ...
        <div class="modal-dialog modal-dialog-centered modal-m" role="dialog">
            <div class="modal-content card-accent-success">
                <div class="modal-body border-success">
                    <h1 class="modal-title text-success"><i class="fa fa-edit"></i> <span id="addclaimheader">Edit
                            Professional Fees/Charges</span></h1>
                    <ul class="list-group">
                    ...
                    <div class="alert alert-info" role="alert"><i class="fa fa-info fa-lg"></i>&nbsp
                        ...
                        are required in the submission of claim!
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="profaccreno" name="profaccreno"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" step="0.01" class="form-control" id="profcopayment"
                            name="profcopayment" placeholder="Co-payment Amount" step="0.01">
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer bg-secondary">
                    <button type="submit" name="sSubmit" class="btn btn-success btn-lg	btn-block btn-ladda"
                        data-style="slide-right"><i class="fa fa-save"></i> &nbsp SAVE</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="CaseRateSearchList" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <h4>
                        <ul class="list-group list-group-horizontal" id="casRateList">
                            <li class="list-group-item"><i class="fa fa-times text-danger" aria-hidden="true"></i> List
                                icons can</li>
                        </ul>
                    </h4>
                    <table id="TblCaseRateList"
                        class="table table-hover table-sm table table-striped table-borderless table-condensed"
                        width="100%">
                        <thead class="thead-dark">
                            <tr>
                                <th>CASE CODE</th>
                ...
                <div class="modal-footer bg-secondary">
                    <a href="javascript:void(0);" class="btn btn-success btn-square btn-ladda btn-lg"
                        id="selectCaseRateBtn" data-style="zoom-in"><i class="fa fa-check"></i></a>
                    <a href="javascript:void(0);" class="btn btn-danger btn-square btn-ladda btn-lg"
                        id="closeCaseRateModalBtn" data-style="zoom-in"><i class="fa fa-close"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    $('#TblPatSearchList').on('dblclick', 'tr', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#PatHistoryList > div > div > div.modal-body > h1").html(
                    '<i class="fa fa-th-list"></i> Claim Log');
...
$('#specialForm').validate({
    ...
    rules: {
        pLeftEyeIOLExpiryDate: {
            required: {
                depends: function(element) {
                    return $("#pLeftEyeIOLStickerNumber").val() != '' && $("#pLeftEyeIOLStickerNumber")
                        .val() != undefined && $("#pLeftEyeIOLStickerNumber").val() != null;
                }
            }
        },
        pLeftEyeIOLStickerNumber: {
            required: {
                depends: function(element) {
                    return $("#pLeftEyeIOLExpiryDate").val() != '' && $("#pLeftEyeIOLExpiryDate").val() !=
                        undefined && $("#pLeftEyeIOLExpiryDate").val() != null;
                }
            }
        },
        pRightEyeIOLExpiryDate: {
            required: {
                depends: function(element) {
                    return $("#pRightEyeIOLStickerNumber").val() != '' && $("#pRightEyeIOLStickerNumber")
                        .val() != undefined && $("#pRightEyeIOLStickerNumber").val() != null;
                }
            }
        },
        pRightEyeIOLStickerNumber: {
            required: {
                depends: function(element) {
                    return $("#pRightEyeIOLExpiryDate").val() != '' && $("#pRightEyeIOLExpiryDate").val() !=
                        undefined && $("#pRightEyeIOLExpiryDate").val() != null;
                }
            }
        },
        pcheckupdate1: {
        ...
        pabpothers: {
            required: {
                depends: function(element) {
                    return $("#pabpspecify").val() != '' && $("#pabpspecify").val() != undefined && $(
                        "#pabpspecify").val() != null;
                }
            }
        },
        pabpspecify: {
            required: {
                depends: function(element) {
                    return $("#pabpothers").val() != '' && $("#pabpothers").val() != undefined && $(
                        "#pabpothers").val() != null;
                }
            }
        },
        pessentialnewborncare: {
            required: {
                depends: function(element) {
                    return $("#cnt_newbo").val() > 0 && $("#pessentialnewborncare").prop("checked") ==
                        false;
                }
            }
        },
        ...
        pdrying: {
            required: {
                depends: function(element) {
                    return $("#cnt_newbo").val() > 0 && $("#pessentialnewborncare").prop("checked") ==
                        true && $("#pdrying").prop("checked") == false;
                }
            }
        },
        pcordclamping: {
...
function loadConsumptionofBenefits(enccode) {
    ...
    $.get(baseURI + "Philhealth/getFirstCases/" + enccode, function(data) {
        for (i in data) {
            if (obj['firstcase'] == data[i].casecode) {
                $("#firstcase").append("<option value='" + data[i].casecode + "' selected>" + data[i].casecode +
                    "</option>");
            } else {
                $("#firstcase").append("<option value='" + data[i].casecode + "'>" + data[i].casecode +
                    "</option>");
            }
        }
    }, "json");
    ...
    $.get(baseURI + "Philhealth/getSecondCases/" + enccode, function(data) {
        for (i in data) {
            if (obj['secondcase'] == data[i].casecode) {
                $("#secondcase").append("<option value='" + data[i].casecode + "' selected>" + data[i]
                    .casecode + "</option>");
            } else {
                $("#secondcase").append("<option value='" + data[i].casecode + "'>" + data[i].casecode +
                    "</option>");
            }
        }
    }, "json");
    ...
    if (obj['secondcase'] == null || obj['secondcase'] == 'null' || obj['secondcase'] == undefined || obj[
            'secondcase'] == '') {
        $("#amt2").val(null);
        $("#amthosp2").val(null);
        $("#amtpf2").val(null);
...
$('#frmBenefits').validate({
    ...
    rules: {
        ptotalamouthci: {
            required: {
                depends: function(element) {
                    if ($("#pmemberpatienthci").prop('checked') == true || $("#phmohci").prop('checked') ==
                        true || $("#pothershci").prop('checked') == true) {
                        return true;
                    } else {
                        return false;
                    }
        ...
        pmemberpatienthci: {
            required: {
                depends: function(element) {
                    if (($("#ptotalamouthci").val() != '' || $("#ptotalamouthci").val() > 0) && $(
                            "#phmohci").prop('checked') == false && $("#pothershci").prop('checked') ==
                        false) {
                        return true;
                    } else {
                        return false;
        ...
        phmohci: {
            required: {
                depends: function(element) {
                    if (($("#ptotalamouthci").val() != '' || $("#ptotalamouthci").val() > 0) && $(
                            "#pmemberpatienthci").prop('checked') == false && $("#pothershci").prop(
                            'checked') == false) {
                        return true;
                    } else {
                        return false;
        ...
        pothershci: {
            required: {
                depends: function(element) {
                    if (($("#ptotalamouthci").val() != '' || $("#ptotalamouthci").val() > 0) && $(
                            "#pmemberpatienthci").prop('checked') == false && $("#phmohci").prop(
                            'checked') == false) {
                        return true;
                    } else {
                        return false;
        ...
        ptotalamoutpf: {
            required: {
                depends: function(element) {
                    if ($("#pmemberpatientpf").prop('checked') == true || $("#phmopf").prop('checked') ==
                        true || $("#potherspf").prop('checked') == true) {
                        return true;
                    } else {
                        return false;
                    }
        ...
        pmemberpatientpf: {
            required: {
                depends: function(element) {
                    if (($("#ptotalamoutpf").val() != '' || $("#ptotalamoutpf").val() > 0) && $("#phmopf")
                        .prop('checked') == false && $("#potherspf").prop('checked') == false) {
                        return true;
                    } else {
                        return false;
                    }
        ...
        phmopf: {
            required: {
                depends: function(element) {
                    if (($("#ptotalamoutpf").val() != '' || $("#ptotalamoutpf").val() > 0) && $(
                            "#pmemberpatientpf").prop('checked') == false && $("#potherspf").prop(
                            'checked') == false) {
                        return true;
                    } else {
                        return false;
        ...
        potherspf: {
            required: {
                depends: function(element) {
                    if (($("#ptotalamoutpf").val() != '' || $("#ptotalamoutpf").val() > 0) && $(
                            "#pmemberpatientpf").prop('checked') == false && $("#phmopf").prop('checked') ==
                        false) {
                        return true;
                    } else {
                        return false;
        ...
        pdmsttotal: {
            required: {
                depends: function(element) {
                    if (($("#pdmsttotal").val() < 1 || $("#pdmsttotal").val() == '') && $(
                            "#medsuppliesoutyes").prop('checked') == true) {
                        return true;
                    } else {
                        return false;
        ...
        pexamstotal: {
            required: {
                depends: function(element) {
                    if (($("#pexamstotal").val() < 1 || $("#pexamstotal").val() == '') && $(
                            "#pexaminationsoutyes").prop('checked') == true) {
                        return true;
                    } else {
                        return false;
...
$("#TblCaseRateList").on('click', 'tr', function(event) {
    ...
    if (isSelected(caseRate) == false) {
        $("#casRateList").append(
            '<li class="list-group-item"><a href="javascript:void(0)" class="excludeCaseRate"><i class="fa fa-times text-danger" aria-hidden="true"></i></a><span class="text-success"> ' +
            caseRate + '</span></li>');
    }
});
