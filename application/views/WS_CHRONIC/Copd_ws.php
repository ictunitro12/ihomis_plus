...
<div class="card card-accent-success">
	...
	<div class="card-body table-responsive">
		<form name="copd_form" id="copd_form" method="post">
			<table id="ws_CopdTbl" class="table table-responsive-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr align="center">
...
<script src="<?php echo base_url() ?>assets/scripts/ws_chronic/copd.js"></script>