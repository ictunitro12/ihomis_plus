...
<div class="card card-accent-success">
	...
	<div class="card-body table-responsive">
		<form name="cad_form" id="cad_form" method="post">
			<table id="ws_CadTbl" class="table table-responsive-sm table-bordered table-condensed table-hover" width="100%">
				<thead>
					<tr align="center">
			...
			<div class="modal-content" style="border-radius:16px!important">
				<div class="modal-body">
					<div id="mySubmitProgress">
						<div id="mySubmitBar" style="border-radius:16px!important" class="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
						<div align="center">
...
<script src="<?php echo base_url() ?>assets/scripts/ws_chronic/cad.js"></script>