            ...
            <form id="form-step-2" role="form" data-toggle="validator">
                ...
                <div class="row">
                    <div class="col-md-6 border-right">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="dateRegistration" id="dateRegistration"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-control-mb" name="selCondArrival" id="selCondArrival"
                                    required>
                                    <option value="">Select</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-control-mb-1" name="selDoc_doc"
                                    id="selDoc_doc"></select>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea placeholder="Remarks" class="form-control form-control-mb-1" name="remarks"
                                    id="remarks"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 border-right">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="h4 text-success"><i class="fa fa-ambulance" aria-hidden="true"></i>&nbsp;
                                    For Referral</div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="h4 text-success"><i class="fa fa-user-injured"></i>&nbsp; For
                                    Accident/Injury</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" data-width="100%"
                                    placeholder="Place of Incident(Address)" name="placeIncident"
                                    id="placeIncident"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
