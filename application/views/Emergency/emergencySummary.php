        ...
        <div class="modal-dialog modal-dialog modal-lg" role="dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img id="patientPhoto" src="" class="img-fluid img-thumbnail bg-success" height="200"
                                width="200"></img>
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="text-success"><i class="fa fa-ambulance" aria-hidden="true"></i>&nbsp Referral
                            </h5>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-footer">
                    <button type="submit" name="btnSave" id="btnSave" class="btn btn-info btn-inline  btn-ladda"
                        data-style="slide-right"><i class="fa fa-save"></i>&nbsp SAVE</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"></i>&nbsp
                        CLOSE </button>
                </div>
            </div>
        </div>
