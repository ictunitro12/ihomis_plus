...
<div class="card-body">
<?php $this->load->view('emergency/emergencyProcess.php');?>
<?php $this->load->view('emergency/emergencySummary.php');?>
</div>
</div>
</div>
...
<script src="<?php echo base_url()?>assets/scripts/emergency/addEmergency.js"></script>
