<style>
	...
	table#CancerTable.dataTable tbody tr:hover {
...
<div class="card card-accent-success">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-auto">
				<div class="btn-group pull-right" role="group" aria-label="">
					<a href="<?php echo site_url('Cancer/PatientForm');?>" data-toggle="tooltip" title="Register Patient" class="btn btn-outline-success btn-md  btn-ladda" data-style="zoom-in"><i class="fa fa-user-plus"></i> &nbsp; Patient Register
					</a>
				</div>
			</div>	
		</div>
	...
	<div class="card-body table-responsive">
		<table id="CancerTable"  class="table table-sm table-striped table-bordered table-condensed table-hover" width="100%">
			<thead >
				<tr>
					<th>enccode</th>
					<th>PATIENT ID</th>
					...
					<th>SEX</th>
					<th>BIRTH DATE</th>
					<th>HISTORY <br>(Type of Cancer)</th>
					<th width="80px"></th>
				</tr>
			</thead>
			<tfoot >
			...
			<div class="modal-body">
				...
				<div class="box-body box-profile">
					...
					<ul class="list-group">
						...
						<li class="list-group-item">
							<b class="text text-success"><i class="fa fa-calendar"></i>&nbsp Type of cancer:</b>
							<a class="pull-right text text-success" id="type_cancer">N/A</a>
						</li>
						<li class="list-group-item">
...
<form name ="frmCancerPDF" id="frmCancerPDF" method="post">
	<div class="modal" id="ModalCancer" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-vertical dialog modal-xl" role="dialog">
			<div class="modal-content card-accent-success">
				<div class="modal-header">
					<input name="code" id ="code" type="hidden">
					<h2 class="modal-title text-success"><i class="fa fa-heartbeat"></i>Cancer Registry Form</h2>
				</div>
				<div class="modal-body border-success" id="CancerPDF">
				</div>
...
<script src="<?php echo base_url()?>assets/scripts/cancer/delete.js"></script> 
<script src="<?php echo base_url()?>assets/scripts/cancer/cancer.js"></script>
<script src="<?php echo base_url()?>assets/scripts/cancer/cncer.js"></script>
