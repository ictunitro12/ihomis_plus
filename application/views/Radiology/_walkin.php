...
<div class="row">
    ...
    <div class="col-6 col-md-6 mb-2 ">
        <div class="btn-group float-right" role="group" aria-label="">
            <button type="button" id="btnCharge_add" class="btn btn-outline-success btn-md" data-style="zoom-in"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer ">
                    <div class="btn-group float-right">
                        <button type="submit" class="btn btn-outline-danger btn-ladda" data-style="zoom-in"><i
...
<script src="<?php echo base_url()?>assets/scripts/radiology/_walkin.js"></script>
<script src="<?php echo base_url()?>assets/scripts/radiology/_walkinactions.js"></script>
<script src="<?php echo base_url()?>assets/scripts/radiology/_walkinlib.js"></script>