	...
	<div class="col-md-9">
		...
		<div class="card card-accent-success">
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<h4 class="text text-success"><i class="fa fa-users"></i> <?php echo $header; ?> <?php echo $subheader; ?></h4>
					</div>
					<div class="col-md-6">
						<div class="btn-group pull-right" role="group" aria-label="">
							<button type="button" id="hey" class="btn btn-outline-success" data-style="zoom-in" onclick="PatSearch()"> <i class="fa fa-search"></i>&nbsp; Search Patient</button>
						</div>
					</div>
				</div>
				<hr>
				<ul class="nav nav-tabs nav-justified" id="tabSocialService" role="tablist">
					<li class="nav-item">
						<a class="nav-link text text-success" id="mss-tab" data-toggle="tab" href="#mss" role="tab" aria-controls="mss" a><i class="fa fa-file-pdf fa-2x"></i>&nbsp; MSS Classification</a>
					</li>
					<li class="nav-item">
						<a class="nav-link text text-success" id="fund-tab" data-toggle="tab" href="#fund" role="tab" aria-controls="fund"><i class="fa fa-money fa-2x"></i>&nbsp; Fund Source/s</a>
					</li>
					<li class="nav-item">
						<a class="nav-link text text-success" id="disc-tab" data-toggle="tab" href="#disc" role="tab" aria-controls="disc"><i class="fa fa-percent fa-2x"></i>&nbsp; Discount/s</a>
					</li>
					<li class="nav-item">
						<a class="nav-link text text-success" id="maip-tab" data-toggle="tab" href="#maip" role="tab" aria-controls="maip"><i class="fa fa-money fa-2x"></i>&nbsp; MAIP</a>
					</li>
					<li class="nav-item">
