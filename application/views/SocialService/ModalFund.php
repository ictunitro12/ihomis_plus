<div class="modal fade" id="ModalFund" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="card-body table-responsive">
					<table  id="TableFundList" class="list table table-sm table-striped  table-bordered table-condensed table-hover " width="100%">
						<thead>
							<tr class="thead-dark">
								...
								<th width="200px">Remaining Amount</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
