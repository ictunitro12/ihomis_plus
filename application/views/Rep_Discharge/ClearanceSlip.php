...
<form id="frmClearanceS" name="frmClearanceS" method="post">
<div class="card card-accent-success">
		<div class="card-header">
			<div class="row">
				<div class="col-md-6 col-md-auto">
					<div class="h3 text text-success">
						<h4 class="modal-title text-success"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;Clearance Slip</h4>
					</div>
				</div>
				<div class="col-md-6 col-md-auto">
		...
		<div class="card-body" id="ClearanceS"></div>
...
<script type="text/javascript">
	...
	function PatVisitList(data) {
		...
		$('#visitLogList').on('click', 'tr', function() {
			...
			$('#ModalClearanceS').modal({
				backdrop: "static"
			});
			$('#ClearanceS').html('<embed src="' + "ClearanceSlip_pdf/" + enccode + '" frameborder="2" width="100%" height="800px" id="ClearanceS">');
		});
	}
