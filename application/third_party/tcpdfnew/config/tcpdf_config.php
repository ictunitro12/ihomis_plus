 ...
 */
//define ('PDF_HEADER_LOGO','hospital_logo.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'IHOMIS PLUS (DEPARMENT OF HEALTH)');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'IHOMIS PLUS (DEPARMENT OF HEALTH)');

/**
 * Header title.
 */

//define ('PDF_HEADER_TITLE', FacilityInfo()->hhosname);
